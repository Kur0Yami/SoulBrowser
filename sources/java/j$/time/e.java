...
public abstract /* synthetic */ class e {
    ...
    static {
        ...
        try {
            f21183a[j$.time.temporal.a.MICRO_OF_SECOND.ordinal()] = 2;
        } catch (NoSuchFieldError unused10) {
        }
        try {
            f21183a[j$.time.temporal.a.MILLI_OF_SECOND.ordinal()] = 3;
        } catch (NoSuchFieldError unused11) {
        }
        try {
            f21183a[j$.time.temporal.a.INSTANT_SECONDS.ordinal()] = 4;
