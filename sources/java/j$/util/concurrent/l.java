...
public class l implements Map.Entry {
    ...
    public volatile Object f21313c;
    public volatile l d;
    ...
    public final int hashCode() {
        return this.b.hashCode() ^ this.f21313c.hashCode();
    }

    public final String toString() {
        return j$.com.android.tools.r8.a.Q(this.b, this.f21313c);
    }
    ...
    public l a(int i, Object obj) {
        ...
        l lVar = this;
        do {
            if (lVar.f21312a == i && ((obj2 = lVar.b) == obj || (obj2 != null && obj.equals(obj2)))) {
                return lVar;
            }
            lVar = lVar.d;
        } while (lVar != null);
