...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements java.util.concurrent.ConcurrentMap<K, V>, Serializable, ConcurrentMap<K, V> {
    ...
    public volatile transient l[] f21305a;
    public volatile transient l[] b;
    private volatile transient long baseCount;

    /* renamed from: c, reason: collision with root package name */
    public volatile transient c[] f21306c;
    ...
    public static final boolean b(l[] lVarArr, int i2, l lVar) {
        return j$.com.android.tools.r8.a.L(h.f21130a, lVarArr, (i2 << o) + n, lVar);
    }
    ...
    */
    public V get(java.lang.Object r4) {
        /*
            ...
            int r0 = r4.hashCode()
            int r0 = i(r0)
            j$.util.concurrent.l[] r1 = r3.f21305a
            if (r1 == 0) goto L4d
            int r2 = r1.length
            if (r2 <= 0) goto L4d
            int r2 = r2 + (-1)
            ...
            if (r2 == 0) goto L36
        L28:
            java.lang.Object r4 = r1.f21313c
            return r4
        L2b:
            if (r2 >= 0) goto L36
            j$.util.concurrent.l r4 = r1.a(r0, r4)
            if (r4 == 0) goto L4d
            java.lang.Object r4 = r4.f21313c
            return r4
        L36:
    ...
    */
    public final java.lang.Object g(java.lang.Object r13, java.lang.Object r14, java.lang.Object r15) {
        /*
            ...
            int r0 = r13.hashCode()
            int r0 = i(r0)
            j$.util.concurrent.l[] r1 = r12.f21305a
        La:
            r2 = 0
            if (r1 == 0) goto Lc0
            int r3 = r1.length
        ...
        L25:
            ...
            r5 = r4
        L31:
            int r9 = r5.f21312a     // Catch: java.lang.Throwable -> L42
            if (r9 != r0) goto L65
        ...
        L42:
            ...
            goto Lbe
        L45:
            java.lang.Object r9 = r5.f21313c     // Catch: java.lang.Throwable -> L42
            if (r15 == 0) goto L53
            if (r15 == r9) goto L53
            if (r9 == 0) goto Lb0
        ...
        L53:
            if (r14 == 0) goto L58
            r5.f21313c = r14     // Catch: java.lang.Throwable -> L42
            goto Lb1
        L58:
            if (r8 == 0) goto L5f
        ...
        L6e:
            ...
            if (r8 == 0) goto Lb0
            java.lang.Object r9 = r8.f21313c     // Catch: java.lang.Throwable -> L42
            if (r15 == 0) goto L8d
            if (r15 == r9) goto L8d
            if (r9 == 0) goto Lb0
            boolean r10 = r15.equals(r9)     // Catch: java.lang.Throwable -> L42
        ...
        L8d:
            if (r14 == 0) goto L92
            r8.f21313c = r14     // Catch: java.lang.Throwable -> L42
            goto Lb1
        L92:
    ...
    public final int hashCode() {
        ...
        if (lVarArr != null) {
            ...
            while (true) {
                ...
                i2 += a2.f21313c.hashCode() ^ a2.b.hashCode();
            }
        }
        return i2;
    }
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) {
        ...
        if (lVarArr != null) {
            ...
            while (true) {
                ...
                objectOutputStream.writeObject(a2.f21313c);
            }
        }
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        while (lVar != null) {
            ...
            if (k2 == null) {
                ...
                Object obj2 = lVar.b;
                if (k2.f21312a < 0) {
                    if (((q) k2).e(i3, obj2, lVar.f21313c) == null) {
                        j4 += j2;
                    }
                    j3 = j2;
                } else {
                    ...
                    for (l lVar3 = k2; lVar3 != null; lVar3 = lVar3.d) {
                        if (lVar3.f21312a == i3 && ((obj = lVar3.b) == obj2 || (obj != null && obj2.equals(obj)))) {
                            z = false;
                            break;
                        }
                        i5++;
                    ...
                    if (z && i5 >= 8) {
                        ...
                        r rVar2 = null;
                        while (lVar4 != null) {
                            r rVar3 = new r(lVar4.f21312a, lVar4.b, lVar4.f21313c, null, null);
                            rVar3.h = rVar2;
                            if (rVar2 == null) {
                                rVar = rVar3;
                            } else {
    ...
    public final void forEach(BiConsumer biConsumer) {
        ...
        while (true) {
            ...
            if (a2 == null) {
                ...
                biConsumer.accept(a2.b, a2.f21313c);
            }
        }
    }
    ...
    */
    public final java.lang.Object computeIfPresent(java.lang.Object r14, java.util.function.BiFunction r15) {
        /*
            ...
            int r1 = r14.hashCode()
            int r1 = i(r1)
            j$.util.concurrent.l[] r2 = r13.f21305a
            r3 = 0
            r5 = r0
            r4 = r3
        L12:
        ...
        L2e:
            ...
            r8 = r7
        L3a:
            int r11 = r8.f21312a     // Catch: java.lang.Throwable -> L4b
            if (r11 != r1) goto L65
        ...
        L4b:
            ...
            goto Lb5
        L4e:
            java.lang.Object r5 = r8.f21313c     // Catch: java.lang.Throwable -> L4b
            java.lang.Object r5 = r15.apply(r14, r5)     // Catch: java.lang.Throwable -> L4b
            if (r5 == 0) goto L59
            r8.f21313c = r5     // Catch: java.lang.Throwable -> L4b
            goto Lab
        L59:
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:125:0x0140, code lost:
        ...
        if (r1.f21306c != r6) goto L150;
     */
    /* JADX WARN: Code restructure failed: missing block: B:126:0x0142, code lost:
    
        r1.f21306c = (j$.util.concurrent.c[]) java.util.Arrays.copyOf(r6, r7 << 1);
     */
    ...
    */
    ...
    public final l[] d(l[] lVarArr, l lVar) {
        ...
        if (lVar instanceof g) {
            ...
            while (lVarArr2 == this.b && this.f21305a == lVarArr && (i2 = this.sizeCtl) < 0 && (i2 >>> 16) == numberOfLeadingZeros && i2 != numberOfLeadingZeros + 1 && i2 != 65535 + numberOfLeadingZeros && this.transferIndex > 0) {
        ...
        while (true) {
            ...
            if (i3 >= 0) {
                ...
                if (lVarArr != null && (length = lVarArr.length) != 0) {
                    ...
                    if (h.c(this, i, i3, -1)) {
                        try {
                            if (this.f21305a == lVarArr) {
                                this.f21305a = new l[i4];
                                i3 = i4 - (i4 >>> 2);
                            }
                        } finally {
                            this.sizeCtl = i3;
            ...
            if (z3) {
                ...
                if (i14 >= i13 || z4) {
                    ...
                    if (i15 <= 0) {
                        ...
                        boolean c4 = aVar.c(concurrentHashMap, j2, i15, i4);
                        i13 = i4;
                        if (c4) {
                            i12 = i15 - 1;
                        } else {
                ...
                if (i12 < 0 || i12 >= length || (i7 = i12 + length) >= length2) {
                    ...
                    if (z4) {
                        ...
                        concurrentHashMap.f21305a = lVarArr3;
                                ...
                                try {
                                    if (k(lVarArr, i12) == k2) {
                                        if (i20 >= 0) {
                                            ...
                                            l lVar = k2;
                                            while (lVar != rVar3) {
                                                int i23 = lVar.f21312a;
                                                Object obj = lVar.b;
                                                int i24 = length;
                                                Object obj2 = lVar.f21313c;
                                                if ((i23 & i24) == 0) {
                                                    i8 = i11;
                                            ...
                                            if (k2 instanceof q) {
                                                ...
                                                while (lVar2 != null) {
                                                    q qVar4 = qVar3;
                                                    int i27 = lVar2.f21312a;
                                                    r rVar8 = new r(i27, lVar2.b, lVar2.f21313c, null, null);
                                                    if ((i27 & i5) == 0) {
                                                        rVar8.h = rVar6;
                                                        if (rVar6 == null) {
                                                            rVar2 = rVar8;
        ...
        synchronized (k2) {
            try {
                if (k(lVarArr, i2) == k2) {
                    ...
                    l lVar = k2;
                    while (lVar != null) {
                        r rVar3 = new r(lVar.f21312a, lVar.b, lVar.f21313c, null, null);
                        rVar3.h = rVar2;
                        if (rVar2 == null) {
                            rVar = rVar3;
                        } else {
    ...
    public static l p(r rVar) {
        ...
        for (r rVar2 = rVar; rVar2 != null; rVar2 = rVar2.d) {
            l lVar3 = new l(rVar2.f21312a, rVar2.b, rVar2.f21313c);
            if (lVar2 == null) {
                lVar = lVar3;
            } else {
                lVar2.d = lVar3;
