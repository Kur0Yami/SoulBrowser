...
public final class x implements Spliterator.OfLong {
    ...
    public final x trySplit() {
        ...
        this.f21324a = j2;
        return new x(j, j2, this.f21325c, this.d);
    }

    @Override // j$.util.Spliterator
    public final long estimateSize() {
        return this.b - this.f21324a;
    }
    ...
    public final boolean tryAdvance(LongConsumer longConsumer) {
        ...
        longConsumer.accept(ThreadLocalRandom.current().c(this.f21325c, this.d));
        this.f21324a = j + 1;
        return true;
    }
    ...
    public final void forEachRemaining(LongConsumer longConsumer) {
        ...
        if (j < j2) {
            ...
            do {
                longConsumer.accept(current.c(this.f21325c, this.d));
                j++;
            } while (j < j2);
        }
    }
