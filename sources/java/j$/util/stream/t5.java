...
public final class t5 extends e1 {
    ...
    public t5(g1 g1Var, int i, long j, long j2) {
        super(g1Var, i);
        this.t = j;
        this.u = j2;
    }
    ...
    public final Spliterator F0(a aVar, Spliterator spliterator) {
        ...
        if (h0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            long j = this.t;
            return new a8(ofLong, j, y5.c(j, this.u));
        }
        if (!c7.ORDERED.i(aVar.m)) {
            ...
            return new j8(ofLong2, j2, j3);
        }
        return ((c2) new x5(this, aVar, spliterator, new y0(21), this.t, this.u).invoke()).spliterator();
    }
    ...
    public final c2 E0(v3 v3Var, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (h0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return v3.a0(v3Var, y5.b(aVar.C0(), spliterator, this.t, this.u), true);
        }
        if (!c7.ORDERED.i(((a) v3Var).m)) {
            Spliterator.OfLong ofLong = (Spliterator.OfLong) v3Var.x0(spliterator);
            long j3 = this.t;
            long j4 = this.u;
            if (j3 <= h0) {
                long j5 = h0 - j3;
            ...
            return v3.a0(this, new j8(ofLong, j2, j), true);
        }
