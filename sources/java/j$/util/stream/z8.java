...
public final class z8 extends e1 implements f9 {
    @Override // j$.util.stream.a
    public final Spliterator F0(a aVar, Spliterator spliterator) {
        if (c7.ORDERED.i(aVar.m)) {
            return E0(aVar, spliterator, new y0(28)).spliterator();
        }
        return new t9((Spliterator.OfLong) aVar.x0(spliterator));
    }
