...
public final class q implements Map.Entry {
    ...
    public final Map.Entry f21371a;

    public q(Map.Entry entry) {
        this.f21371a = (Map.Entry) Objects.requireNonNull(entry);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj instanceof Map.Entry) {
                ...
                Object key = this.f21371a.getKey();
                ...
                if (equals) {
                    Object value = this.f21371a.getValue();
