...
final class ViewingConditions {
    ...
    static {
        ...
        float[] fArr = CamUtils.f658c;
        float f2 = fArr[0];
        float[][] fArr2 = CamUtils.f657a;
        float[] fArr3 = fArr2[0];
        float f3 = fArr3[0] * f2;
        float f4 = fArr[1];
        ...
        k = new ViewingConditions(c3, ((fArr7[2] * 0.05f) + (fArr7[0] * 2.0f) + fArr7[1]) * pow, pow, pow, f10, 1.0f, new float[]{(((100.0f / f7) * exp) + 1.0f) - exp, (((100.0f / f8) * exp) + 1.0f) - exp, (((100.0f / f9) * exp) + 1.0f) - exp}, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
