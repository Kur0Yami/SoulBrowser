...
final class CamUtils {
    ...
    public static final float[][] f657a = {new float[]{0.401288f, 0.650173f, -0.051461f}, new float[]{-0.250268f, 1.204414f, 0.045854f}, new float[]{-0.002079f, 0.048952f, 0.953127f}};
    ...
    public static final float[] f658c = {95.047f, 100.0f, 108.883f};
    ...
    public static int a(float f) {
        ...
        float[] fArr = f658c;
        return ColorUtils.d(f3 * fArr[0], f2 * fArr[1], f5 * fArr[2]);
    }
