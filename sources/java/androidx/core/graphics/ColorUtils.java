...
public final class ColorUtils {
    ...
    public static final ThreadLocal f680a = new ThreadLocal();
    ...
    public static int d(double d, double d2, double d3) {
        ...
        return Color.rgb(k((int) Math.round(d4 * 255.0d)), k((int) Math.round(d5 * 255.0d)), k((int) Math.round(d6 * 255.0d)));
    }
    ...
    public static int h(float f, int i, int i2) {
        ...
        if (alpha == 255) {
            double d = f;
            if (f(l(i, KotlinVersion.MAX_COMPONENT_VALUE), i2) < d) {
                return -1;
            }
            int i4 = 0;
