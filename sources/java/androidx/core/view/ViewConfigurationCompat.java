...
public final class ViewConfigurationCompat {
    ...
    public static final Method f801a;
    ...
    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f801a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", null);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f801a) != null) {
            try {
