...
public class FragmentFactory {
    ...
    public static final SimpleArrayMap f1100a = new SimpleArrayMap(0);

    public static Class b(ClassLoader classLoader, String str) {
        SimpleArrayMap simpleArrayMap = f1100a;
    ...
    public static Class c(ClassLoader classLoader, String str) {
        try {
            ...
            throw new RuntimeException(android.support.v4.media.a.l("Unable to instantiate fragment ", str, ": make sure class is a valid subclass of Fragment"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(android.support.v4.media.a.l("Unable to instantiate fragment ", str, ": make sure class name exists"), e2);
        }
    }
