...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
    public static boolean s(Transition transition) {
        if (FragmentTransitionImpl.h(transition.getTargetIds()) && FragmentTransitionImpl.h(transition.getTargetNames()) && FragmentTransitionImpl.h(transition.getTargetTypes())) {
            return false;
        }
        return true;
    }
    ...
    public final void l(Object obj, final Object obj2, final ArrayList arrayList, final Object obj3, final ArrayList arrayList2) {
        ((Transition) obj).addListener(new Transition.TransitionListener() { // from class: androidx.fragment.app.FragmentTransitionCompat21.3
            ...
            public final void onTransitionStart(Transition transition) {
                ...
                Object obj5 = obj3;
                if (obj5 != null) {
                    fragmentTransitionCompat21.t(obj5, arrayList2, null);
                }
            }
        });
    }
    ...
    public final void p(Object obj, View view, ArrayList arrayList) {
        ...
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            FragmentTransitionImpl.d(targets, (View) arrayList.get(i));
        }
        targets.add(view);
        arrayList.add(view);
