...
final class CredentialProviderBeginSignInController$handleResponse$1 extends Lambda implements Function2<CancellationSignal, Function0<? extends Unit>, Unit> {
    static {
        new Lambda(2);
    }
    ...
    public final Unit invoke(CancellationSignal cancellationSignal, Function0<? extends Unit> function0) {
        ...
        int i2 = CredentialProviderBeginSignInController.e;
