...
public final class SavedStateViewModelFactoryKt {
    ...
    public static final List f1225a = CollectionsKt.listOf((Object[]) new Class[]{Application.class, SavedStateHandle.class});
    public static final List b = CollectionsKt.listOf(SavedStateHandle.class);
    ...
    public static final ViewModel b(Class modelClass, Constructor constructor, Object... params) {
        Intrinsics.checkNotNullParameter(modelClass, "modelClass");
