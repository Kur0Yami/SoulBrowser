...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Landroidx/lifecycle/Lifecycling;", RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED, "lifecycle-common"}, k = 1, mv = {1, 8, 0}, xi = 48)
@RestrictTo
        ...
        if (cls.getCanonicalName() != null) {
            ...
            try {
                ...
                if (r4 != null) {
                    ...
                    fullPackage = RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED;
                }
            ...
            if (constructor != null) {
                ...
                HashMap hashMap3 = classesInfoCache.b;
                        ...
                        while (true) {
                            if (i2 < length) {
                                if (((OnLifecycleEvent) declaredMethods[i2].getAnnotation(OnLifecycleEvent.class)) != null) {
                                    classesInfoCache.a(cls, declaredMethods);
                                    z = true;
                                    break;
                                }
                                i2++;
