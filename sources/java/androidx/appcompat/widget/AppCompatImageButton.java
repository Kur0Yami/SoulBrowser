...
public class AppCompatImageButton extends ImageButton implements TintableBackgroundView, TintableImageSourceView {
    ...
    public final AppCompatBackgroundHelper f245c;
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public final void mapProperties(PropertyMapper propertyMapper) {
            this.f246a = propertyMapper.mapObject("backgroundTint", R.attr.backgroundTint);
            this.b = propertyMapper.mapObject("backgroundTintMode", R.attr.backgroundTintMode);
            this.f247c = propertyMapper.mapObject("tint", R.attr.tint);
        ...
        public final void readProperties(Object obj, PropertyReader propertyReader) {
            ...
            propertyReader.readObject(this.f246a, appCompatImageButton.getBackgroundTintList());
            propertyReader.readObject(this.b, appCompatImageButton.getBackgroundTintMode());
            propertyReader.readObject(this.f247c, appCompatImageButton.getImageTintList());
    ...
    public AppCompatImageButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f245c = appCompatBackgroundHelper;
    ...
    public final void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f245c;
