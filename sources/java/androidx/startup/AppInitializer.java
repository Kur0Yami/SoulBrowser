...
public final class AppInitializer {
    ...
    public AppInitializer(Context context) {
        this.f1665c = context.getApplicationContext();
    }
    ...
    public final void a(Bundle bundle) {
        HashSet hashSet;
        String string = this.f1665c.getString(R.string.androidx_startup);
        if (bundle != null) {
            try {
