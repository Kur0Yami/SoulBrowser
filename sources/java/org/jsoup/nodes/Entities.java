...
public class Entities {
    ...
    public static final char[] f22571a = {',', ';'};
    public static final HashMap b = new HashMap();

    /* renamed from: c, reason: collision with root package name */
    public static final ArrayList f22572c = new ArrayList(106);
    public static final b d = new b(new org.apache.commons.lang3.builder.a(3), 4);
    ...
    public static final class CoreCharset {
        ...
        /* renamed from: c, reason: collision with root package name */
        public static final CoreCharset f22574c;
        public static final CoreCharset f;
        public static final CoreCharset g;
        public static final /* synthetic */ CoreCharset[] h;
    ...
    public enum EscapeMode {
        ...
        static {
            ...
            ArrayList arrayList = Entities.f22572c;
            Collections.addAll(arrayList, escapeMode.f22575c);
            List.EL.sort(arrayList, new Object());
        }

        EscapeMode(int i2, String str) {
            int i3;
            char[] cArr = Entities.f22571a;
            this.f22575c = new String[i2];
            this.f = new int[i2];
            this.g = new int[i2];
            ...
            while (!characterReader.isEmpty()) {
                try {
                    ...
                    int parseInt = Integer.parseInt(characterReader.consumeToAny(Entities.f22571a), 36);
                    ...
                    characterReader.advance();
                    this.f22575c[i4] = consumeTo;
                    this.f[i4] = parseInt;
                    this.g[parseInt2] = parseInt;
                    this.h[parseInt2] = consumeTo;
                    if (i3 != -1) {
                        Entities.b.put(consumeTo, new String(new int[]{parseInt, i3}, 0, 2));
                    }
                    i4++;
                } catch (Throwable th) {
                    try {
        ...
        public final int a(String str) {
            int binarySearch = Arrays.binarySearch(this.f22575c, str);
            if (binarySearch >= 0) {
    ...
    public static void a(QuietAppendable quietAppendable, EscapeMode escapeMode, int i) {
        String str;
        int binarySearch = Arrays.binarySearch(escapeMode.g, i);
        if (binarySearch >= 0) {
            String[] strArr = escapeMode.h;
            if (binarySearch < strArr.length - 1) {
                int i2 = binarySearch + 1;
                if (escapeMode.g[i2] == i) {
                    str = strArr[i2];
                }
            }
        ...
        if (!RequestConfiguration.MAX_AD_CONTENT_RATING_UNSPECIFIED.equals(str)) {
            quietAppendable.append(Typography.amp).append(str).append(';');
        } else {
            quietAppendable.append("&#x").append(Integer.toHexString(i)).append(';');
        }
    }

    public static boolean b(CoreCharset coreCharset, char c2, CharsetEncoder charsetEncoder) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0034, code lost:
        ...
        if (r4.charset().equals(r6) == false) goto L15;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static void c(java.lang.String r16, org.jsoup.internal.QuietAppendable r17, org.jsoup.nodes.Entities.EscapeMode r18, java.nio.charset.Charset r19, int r20) {
        /*
            Method dump skipped, instructions count: 347
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.jsoup.nodes.Entities.c(java.lang.String, org.jsoup.internal.QuietAppendable, org.jsoup.nodes.Entities$EscapeMode, java.nio.charset.Charset, int):void");
    }
    ...
    public static String escape(String str, Document.OutputSettings outputSettings) {
        ...
        c(str, QuietAppendable.wrap(borrowBuilder), escapeMode, charset, 3);
        return StringUtil.releaseBuilder(borrowBuilder);
    }

    public static String findPrefix(String str) {
        ArrayList arrayList = f22572c;
    ...
    public static boolean isNamedEntity(String str) {
        if (EscapeMode.extended.a(str) != -1) {
            return true;
        }
        return false;
    }
