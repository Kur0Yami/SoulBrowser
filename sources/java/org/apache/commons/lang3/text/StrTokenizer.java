...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    public String[] f;
    public int g;
    public StrMatcher h = StrMatcher.f22394c;
    public StrMatcher i;
    public StrMatcher j;
    public StrMatcher k;
    public boolean l;
    ...
    static {
        ...
        strTokenizer.h = StrMatcher.f22393a;
    ...
    public final Object clone() {
        try {
            ...
            char[] cArr = strTokenizer.f22395c;
            if (cArr != null) {
                strTokenizer.f22395c = (char[]) cArr.clone();
            }
            strTokenizer.g = 0;
            strTokenizer.f = null;
            return strTokenizer;
                ...
                if (i4 > 0 && c(cArr, i, i2, i3, i4)) {
                    ...
                    if (a3 <= 0) {
                        ...
                        if (a3 > 0) {
                            ...
                            char c22 = cArr[i];
                            strBuilder.c(strBuilder.f + 1);
                            char[] cArr22 = strBuilder.f22392c;
    ...
    /* JADX WARN: Type inference failed for: r4v0, types: [java.lang.Object, org.apache.commons.lang3.text.StrBuilder] */
