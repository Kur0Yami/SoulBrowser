...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public final StrBuilder a(String str) {
        ...
        if (str != null && (length = str.length()) > 0) {
            int i = this.f;
            c(i + length);
            str.getChars(0, length, this.f22392c, i);
            this.f += length;
        }
        return this;
    }
        ...
        if (charSequence != null) {
            if (charSequence instanceof StrBuilder) {
                ...
                if (i > 0) {
                    int i2 = this.f;
                    c(i2 + i);
                    System.arraycopy(strBuilder.f22392c, 0, this.f22392c, i2, i);
                    this.f += i;
                    return this;
                }
                ...
                if (length > 0) {
                    int i3 = this.f;
                    c(i3 + length);
                    sb.getChars(0, length, this.f22392c, i3);
                    this.f += length;
                    return this;
                }
                ...
                if (length2 > 0) {
                    int i4 = this.f;
                    c(i4 + length2);
                    stringBuffer.getChars(0, length2, this.f22392c, i4);
                    this.f += length2;
                }
            } else {
                if (charSequence instanceof CharBuffer) {
                    ...
                    if (charBuffer.hasArray()) {
                        ...
                        int i5 = this.f;
                        c(i5 + remaining);
                        System.arraycopy(charBuffer.array(), charBuffer.position() + charBuffer.arrayOffset(), this.f22392c, i5, remaining);
                        this.f += remaining;
                        return this;
                    }
            ...
            if (i >= 0 && i <= cArr.length) {
                if (i2 >= 0 && i + i2 <= cArr.length) {
                    if (i2 > 0) {
                        int i3 = this.f;
                        c(i3 + i2);
                        System.arraycopy(cArr, i, this.f22392c, i3, i2);
                        this.f += i2;
                        return;
                    }
                    return;
    ...
    public final String d(int i, int i2) {
        if (i >= 0) {
            ...
            if (i <= i2) {
                return new String(this.f22392c, i, i2 - i);
            }
    ...
    public final String toString() {
        return new String(this.f22392c, 0, this.f);
    }
        ...
        if (charSequence != null && (charSequence2 = charSequence.toString()) != null) {
            if (i >= 0 && i <= charSequence2.length()) {
                ...
                if (i2 > 0) {
                    int i4 = this.f;
                    c(i4 + i2);
                    charSequence2.getChars(i, i3, this.f22392c, i4);
                    this.f += i2;
                }
            } else {
