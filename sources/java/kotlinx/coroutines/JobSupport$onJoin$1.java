...
final /* synthetic */ class JobSupport$onJoin$1 extends FunctionReferenceImpl implements Function3<JobSupport, SelectInstance<?>, Object, Unit> {
    static {
        new FunctionReferenceImpl(3, JobSupport.class, "registerSelectForOnJoin", "registerSelectForOnJoin(Lkotlinx/coroutines/selects/SelectInstance;Ljava/lang/Object;)V", 0);
    }
    ...
    public final Unit invoke(JobSupport jobSupport, SelectInstance<?> selectInstance, Object obj) {
        ...
        while (true) {
            ...
            if (jobSupport2.f0(S) >= 0) {
                selectInstance2.a(jobSupport2.i(false, true, new JobSupport.SelectOnJoinCompletionHandler(selectInstance2)));
                break;
            }
        }
