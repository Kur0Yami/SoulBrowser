...
public class UArraysKt___UArraysJvmKt {
    ...
    public static final List<UInt> m498asListajY9A(@NotNull int[] iArr) {
    ...
    public static final List<UByte> m499asListGBYM_sE(@NotNull byte[] bArr) {
    ...
    public static final List<ULong> m500asListQwZRm1k(@NotNull long[] jArr) {
    ...
    public static final List<UShort> m501asListrL5Bavg(@NotNull short[] sArr) {
    ...
    public static final int m502binarySearch2fe2U9s(@NotNull int[] iArr, int i, int i2, int i3) {
        Intrinsics.checkNotNullParameter(iArr, "$v$c$kotlin-UIntArray$-$this$binarySearch$0");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i2, i3, UIntArray.m186getSizeimpl(iArr));
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
    ...
    public static /* synthetic */ int m503binarySearch2fe2U9s$default(int[] iArr, int i, int i2, int i3, int i4, Object obj) {
        ...
        if ((i4 & 4) != 0) {
            i3 = UIntArray.m186getSizeimpl(iArr);
        }
        return m502binarySearch2fe2U9s(iArr, i, i2, i3);
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: binarySearch-EtDCXyQ, reason: not valid java name */
    public static final int m504binarySearchEtDCXyQ(@NotNull short[] sArr, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(sArr, "$v$c$kotlin-UShortArray$-$this$binarySearch$0");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m370getSizeimpl(sArr));
    ...
    public static /* synthetic */ int m505binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m370getSizeimpl(sArr);
        }
        return m504binarySearchEtDCXyQ(sArr, s, i, i2);
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: binarySearch-K6DWlUc, reason: not valid java name */
    public static final int m506binarySearchK6DWlUc(@NotNull long[] jArr, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(jArr, "$v$c$kotlin-ULongArray$-$this$binarySearch$0");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m265getSizeimpl(jArr));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static /* synthetic */ int m507binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        ...
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m265getSizeimpl(jArr);
        }
        return m506binarySearchK6DWlUc(jArr, j, i, i2);
    }

    @SinceKotlin(version = "1.3")
    @ExperimentalUnsignedTypes
    /* renamed from: binarySearch-WpHrYlw, reason: not valid java name */
    public static final int m508binarySearchWpHrYlw(@NotNull byte[] bArr, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(bArr, "$v$c$kotlin-UByteArray$-$this$binarySearch$0");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m107getSizeimpl(bArr));
    ...
    public static /* synthetic */ int m509binarySearchWpHrYlw$default(byte[] bArr, byte b, int i, int i2, int i3, Object obj) {
        ...
        return m508binarySearchWpHrYlw(bArr, b, i, i2);
    }
    ...
    private static final byte m510elementAtPpDY95g(byte[] bArr, int i) {
        ...
        return UByteArray.m106getw2LRezQ(bArr, i);
    }
    ...
    private static final short m511elementAtnggk6HY(short[] sArr, int i) {
        ...
        return UShortArray.m369getMh2AYeg(sArr, i);
    }
    ...
    private static final int m512elementAtqFRl0hI(int[] iArr, int i) {
        ...
        return UIntArray.m185getpVg5ArA(iArr, i);
    }
    ...
    private static final long m513elementAtr7IrZao(long[] jArr, int i) {
        ...
        return ULongArray.m264getsVKNKU(jArr, i);
    }
    ...
    public static final /* synthetic */ UInt m514maxajY9A(int[] iArr) {
        ...
        return UArraysKt___UArraysKt.m886maxOrNullajY9A(iArr);
    }
    ...
    public static final /* synthetic */ UByte m515maxGBYM_sE(byte[] bArr) {
        ...
        return UArraysKt___UArraysKt.m887maxOrNullGBYM_sE(bArr);
    }
    ...
    public static final /* synthetic */ ULong m516maxQwZRm1k(long[] jArr) {
        ...
        return UArraysKt___UArraysKt.m888maxOrNullQwZRm1k(jArr);
    }
    ...
    public static final /* synthetic */ UShort m517maxrL5Bavg(short[] sArr) {
        ...
        return UArraysKt___UArraysKt.m889maxOrNullrL5Bavg(sArr);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m518maxByJOV_ifY(byte[] bArr, Function1<? super UByte, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(bArr, "$v$c$kotlin-UByteArray$-$this$maxBy$0");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UByteArray.m109isEmptyimpl(bArr)) {
            return null;
        }
        byte m106getw2LRezQ = UByteArray.m106getw2LRezQ(bArr, 0);
        int lastIndex = ArraysKt.getLastIndex(bArr);
        if (lastIndex == 0) {
            return UByte.m42boximpl(m106getw2LRezQ);
        }
        R invoke = selector.invoke(UByte.m42boximpl(m106getw2LRezQ));
        int i = 1;
        if (1 <= lastIndex) {
            while (true) {
                byte m106getw2LRezQ2 = UByteArray.m106getw2LRezQ(bArr, i);
                R invoke2 = selector.invoke(UByte.m42boximpl(m106getw2LRezQ2));
                if (invoke.compareTo(invoke2) < 0) {
                    m106getw2LRezQ = m106getw2LRezQ2;
                    invoke = invoke2;
                }
                if (i == lastIndex) {
                    break;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m519maxByMShoTSo(long[] jArr, Function1<? super ULong, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(jArr, "$v$c$kotlin-ULongArray$-$this$maxBy$0");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (ULongArray.m267isEmptyimpl(jArr)) {
            return null;
        }
        long m264getsVKNKU = ULongArray.m264getsVKNKU(jArr, 0);
        int lastIndex = ArraysKt.getLastIndex(jArr);
        if (lastIndex == 0) {
            return ULong.m198boximpl(m264getsVKNKU);
        }
        R invoke = selector.invoke(ULong.m198boximpl(m264getsVKNKU));
        int i = 1;
        if (1 <= lastIndex) {
            while (true) {
                long m264getsVKNKU2 = ULongArray.m264getsVKNKU(jArr, i);
                R invoke2 = selector.invoke(ULong.m198boximpl(m264getsVKNKU2));
                if (invoke.compareTo(invoke2) < 0) {
                    m264getsVKNKU = m264getsVKNKU2;
                    invoke = invoke2;
                }
                if (i == lastIndex) {
                    break;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m520maxByjgv0xPQ(int[] iArr, Function1<? super UInt, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(iArr, "$v$c$kotlin-UIntArray$-$this$maxBy$0");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UIntArray.m188isEmptyimpl(iArr)) {
            return null;
        }
        int m185getpVg5ArA = UIntArray.m185getpVg5ArA(iArr, 0);
        int lastIndex = ArraysKt.getLastIndex(iArr);
        if (lastIndex == 0) {
            return UInt.m119boximpl(m185getpVg5ArA);
        }
        R invoke = selector.invoke(UInt.m119boximpl(m185getpVg5ArA));
        int i = 1;
        if (1 <= lastIndex) {
            while (true) {
                int m185getpVg5ArA2 = UIntArray.m185getpVg5ArA(iArr, i);
                R invoke2 = selector.invoke(UInt.m119boximpl(m185getpVg5ArA2));
                if (invoke.compareTo(invoke2) < 0) {
                    m185getpVg5ArA = m185getpVg5ArA2;
                    invoke = invoke2;
                }
                if (i == lastIndex) {
                    break;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m521maxByxTcfx_M(short[] sArr, Function1<? super UShort, ? extends R> selector) {
        Intrinsics.checkNotNullParameter(sArr, "$v$c$kotlin-UShortArray$-$this$maxBy$0");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (UShortArray.m372isEmptyimpl(sArr)) {
            return null;
        }
        short m369getMh2AYeg = UShortArray.m369getMh2AYeg(sArr, 0);
        int lastIndex = ArraysKt.getLastIndex(sArr);
        if (lastIndex == 0) {
            return UShort.m305boximpl(m369getMh2AYeg);
        }
        R invoke = selector.invoke(UShort.m305boximpl(m369getMh2AYeg));
        int i = 1;
        if (1 <= lastIndex) {
            while (true) {
                short m369getMh2AYeg2 = UShortArray.m369getMh2AYeg(sArr, i);
                R invoke2 = selector.invoke(UShort.m305boximpl(m369getMh2AYeg2));
                if (invoke.compareTo(invoke2) < 0) {
                    m369getMh2AYeg = m369getMh2AYeg2;
                    invoke = invoke2;
                }
                if (i == lastIndex) {
                    break;
    ...
    public static final /* synthetic */ UByte m522maxWithXMRcp5o(byte[] bArr, Comparator comparator) {
        ...
        return UArraysKt___UArraysKt.m894maxWithOrNullXMRcp5o(bArr, comparator);
    }
    ...
    public static final /* synthetic */ UInt m523maxWithYmdZ_VM(int[] iArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m895maxWithOrNullYmdZ_VM(iArr, comparator);
    }
    ...
    public static final /* synthetic */ UShort m524maxWitheOHTfZs(short[] sArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m896maxWithOrNulleOHTfZs(sArr, comparator);
    }
    ...
    public static final /* synthetic */ ULong m525maxWithzrEWJaI(long[] jArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m897maxWithOrNullzrEWJaI(jArr, comparator);
    }
    ...
    public static final /* synthetic */ UInt m526minajY9A(int[] iArr) {
        ...
        return UArraysKt___UArraysKt.m942minOrNullajY9A(iArr);
    }
    ...
    public static final /* synthetic */ UByte m527minGBYM_sE(byte[] bArr) {
        ...
        return UArraysKt___UArraysKt.m943minOrNullGBYM_sE(bArr);
    }
    ...
    public static final /* synthetic */ ULong m528minQwZRm1k(long[] jArr) {
        ...
        return UArraysKt___UArraysKt.m944minOrNullQwZRm1k(jArr);
    }
    ...
    public static final /* synthetic */ UShort m529minrL5Bavg(short[] sArr) {
        ...
        return UArraysKt___UArraysKt.m945minOrNullrL5Bavg(sArr);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m530minByJOV_ifY(byte[] bArr, Function1<? super UByte, ? extends R> selector) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m531minByMShoTSo(long[] jArr, Function1<? super ULong, ? extends R> selector) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m532minByjgv0xPQ(int[] iArr, Function1<? super UInt, ? extends R> selector) {
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m533minByxTcfx_M(short[] sArr, Function1<? super UShort, ? extends R> selector) {
    ...
    public static final /* synthetic */ UByte m534minWithXMRcp5o(byte[] bArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m950minWithOrNullXMRcp5o(bArr, comparator);
    }
    ...
    public static final /* synthetic */ UInt m535minWithYmdZ_VM(int[] iArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m951minWithOrNullYmdZ_VM(iArr, comparator);
    }
    ...
    public static final /* synthetic */ UShort m536minWitheOHTfZs(short[] sArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m952minWithOrNulleOHTfZs(sArr, comparator);
    }
    ...
    public static final /* synthetic */ ULong m537minWithzrEWJaI(long[] jArr, Comparator comparator) {
        ...
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return UArraysKt___UArraysKt.m953minWithOrNullzrEWJaI(jArr, comparator);
    }
    ...
    private static final BigDecimal sumOfBigDecimal(int[] iArr, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        for (int i = 0; i < m186getSizeimpl; i++) {
            valueOf = valueOf.add((BigDecimal) com.mycompany.app.dialog.a.i(iArr, i, selector));
    ...
    private static final BigInteger sumOfBigInteger(int[] iArr, Function1<? super UInt, ? extends BigInteger> selector) {
        ...
        int m186getSizeimpl = UIntArray.m186getSizeimpl(iArr);
        for (int i = 0; i < m186getSizeimpl; i++) {
            valueOf = valueOf.add((BigInteger) com.mycompany.app.dialog.a.i(iArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(long[] jArr, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        for (int i = 0; i < m265getSizeimpl; i++) {
            valueOf = valueOf.add((BigDecimal) com.mycompany.app.dialog.a.j(jArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(long[] jArr, Function1<? super ULong, ? extends BigInteger> selector) {
        ...
        int m265getSizeimpl = ULongArray.m265getSizeimpl(jArr);
        for (int i = 0; i < m265getSizeimpl; i++) {
            valueOf = valueOf.add((BigInteger) com.mycompany.app.dialog.a.j(jArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] bArr, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        for (int i = 0; i < m107getSizeimpl; i++) {
            valueOf = valueOf.add((BigDecimal) com.mycompany.app.dialog.a.h(bArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(byte[] bArr, Function1<? super UByte, ? extends BigInteger> selector) {
        ...
        int m107getSizeimpl = UByteArray.m107getSizeimpl(bArr);
        for (int i = 0; i < m107getSizeimpl; i++) {
            valueOf = valueOf.add((BigInteger) com.mycompany.app.dialog.a.h(bArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sArr, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        for (int i = 0; i < m370getSizeimpl; i++) {
            valueOf = valueOf.add((BigDecimal) com.mycompany.app.dialog.a.k(sArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(short[] sArr, Function1<? super UShort, ? extends BigInteger> selector) {
        ...
        int m370getSizeimpl = UShortArray.m370getSizeimpl(sArr);
        for (int i = 0; i < m370getSizeimpl; i++) {
            valueOf = valueOf.add((BigInteger) com.mycompany.app.dialog.a.k(sArr, i, selector));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
