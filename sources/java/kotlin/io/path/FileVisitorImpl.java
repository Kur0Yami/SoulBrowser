...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public /* bridge */ /* synthetic */ FileVisitResult postVisitDirectory(Object obj, IOException iOException) {
        return postVisitDirectory(com.google.common.io.a.a(obj), iOException);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult preVisitDirectory(Object obj, BasicFileAttributes basicFileAttributes) {
        return preVisitDirectory(com.google.common.io.a.a(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFile(Object obj, BasicFileAttributes basicFileAttributes) {
        return visitFile(com.google.common.io.a.a(obj), basicFileAttributes);
    }

    @Override // java.nio.file.SimpleFileVisitor, java.nio.file.FileVisitor
    public /* bridge */ /* synthetic */ FileVisitResult visitFileFailed(Object obj, IOException iOException) {
        return visitFileFailed(com.google.common.io.a.a(obj), iOException);
    }
    ...
    public FileVisitResult postVisitDirectory(@NotNull Path dir, @Nullable IOException exc) {
        ...
        if (function2 != null && (e = com.google.common.net.a.e(function2.invoke(dir, exc))) != null) {
            return e;
        }
    ...
    public FileVisitResult preVisitDirectory(@NotNull Path dir, @NotNull BasicFileAttributes attrs) {
        ...
        if (function2 != null && (e = com.google.common.net.a.e(function2.invoke(dir, attrs))) != null) {
            return e;
        }
    ...
    public FileVisitResult visitFile(@NotNull Path file, @NotNull BasicFileAttributes attrs) {
        ...
        if (function2 != null && (e = com.google.common.net.a.e(function2.invoke(file, attrs))) != null) {
            return e;
        }
    ...
    public FileVisitResult visitFileFailed(@NotNull Path file, @NotNull IOException exc) {
        ...
        if (function2 != null && (e = com.google.common.net.a.e(function2.invoke(file, exc))) != null) {
            return e;
        }
