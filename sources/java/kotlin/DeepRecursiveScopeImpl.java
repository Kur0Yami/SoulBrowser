    ...
    public final R runCallLoop() {
        ...
        while (true) {
            ...
            if (continuation != null) {
                obj = DeepRecursiveKt.UNDEFINED_RESULT;
                if (!Result.m32equalsimpl0(obj, r)) {
                    ...
                    try {
                        ...
                        if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            continuation.resumeWith(Result.m30constructorimpl(invoke));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion = Result.INSTANCE;
                        continuation.resumeWith(Result.m30constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
