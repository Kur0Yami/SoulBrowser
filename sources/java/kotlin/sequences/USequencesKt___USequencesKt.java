...
class USequencesKt___USequencesKt {
    ...
    public static final int sumOfUByte(@NotNull Sequence<UByte> sequence) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m125constructorimpl(UInt.m125constructorimpl(it.next().getData() & UByte.MAX_VALUE) + i);
        }
        return i;
    }
    ...
    public static final int sumOfUInt(@NotNull Sequence<UInt> sequence) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = com.mycompany.app.dialog.a.c(it.next(), i);
        }
        return i;
    }
    ...
    public static final long sumOfULong(@NotNull Sequence<ULong> sequence) {
        ...
        long j = 0;
        while (it.hasNext()) {
            j = ULong.m204constructorimpl(it.next().getData() + j);
        }
        return j;
    }
    ...
    public static final int sumOfUShort(@NotNull Sequence<UShort> sequence) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m125constructorimpl(UInt.m125constructorimpl(it.next().getData() & UShort.MAX_VALUE) + i);
        }
        return i;
    }
}
