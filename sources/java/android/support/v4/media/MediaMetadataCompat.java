...
public final class MediaMetadataCompat implements Parcelable {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [androidx.collection.ArrayMap<java.lang.String, java.lang.Integer>, androidx.collection.SimpleArrayMap] */
    static {
        ?? simpleArrayMap = new SimpleArrayMap(0);
        METADATA_KEYS_TYPE = simpleArrayMap;
        simpleArrayMap.put(METADATA_KEY_TITLE, 1);
        simpleArrayMap.put(METADATA_KEY_ARTIST, 1);
        simpleArrayMap.put(METADATA_KEY_DURATION, 0);
        simpleArrayMap.put(METADATA_KEY_ALBUM, 1);
        simpleArrayMap.put(METADATA_KEY_AUTHOR, 1);
        simpleArrayMap.put(METADATA_KEY_WRITER, 1);
        simpleArrayMap.put(METADATA_KEY_COMPOSER, 1);
        simpleArrayMap.put(METADATA_KEY_COMPILATION, 1);
        simpleArrayMap.put(METADATA_KEY_DATE, 1);
        simpleArrayMap.put(METADATA_KEY_YEAR, 0);
        simpleArrayMap.put(METADATA_KEY_GENRE, 1);
        simpleArrayMap.put(METADATA_KEY_TRACK_NUMBER, 0);
        simpleArrayMap.put(METADATA_KEY_NUM_TRACKS, 0);
        simpleArrayMap.put(METADATA_KEY_DISC_NUMBER, 0);
        simpleArrayMap.put(METADATA_KEY_ALBUM_ARTIST, 1);
        simpleArrayMap.put(METADATA_KEY_ART, 2);
        simpleArrayMap.put(METADATA_KEY_ART_URI, 1);
        simpleArrayMap.put(METADATA_KEY_ALBUM_ART, 2);
        simpleArrayMap.put(METADATA_KEY_ALBUM_ART_URI, 1);
        simpleArrayMap.put(METADATA_KEY_USER_RATING, 3);
        simpleArrayMap.put(METADATA_KEY_RATING, 3);
        simpleArrayMap.put(METADATA_KEY_DISPLAY_TITLE, 1);
        simpleArrayMap.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        simpleArrayMap.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        simpleArrayMap.put(METADATA_KEY_DISPLAY_ICON, 2);
        simpleArrayMap.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        simpleArrayMap.put(METADATA_KEY_MEDIA_ID, 1);
        simpleArrayMap.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        simpleArrayMap.put(METADATA_KEY_MEDIA_URI, 1);
        simpleArrayMap.put(METADATA_KEY_ADVERTISEMENT, 0);
        simpleArrayMap.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
                    ...
                    if (intValue != 1) {
                        if (intValue != 2) {
                            if (intValue != 3) {
                                ...
                                builder.putRating(str, (Rating) this.mBundle.getParcelable(str));
                            }
                        } else {
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ...
            if (arrayMap.containsKey(str) && ((Integer) arrayMap.get(str)).intValue() != 2) {
                throw new IllegalArgumentException(a.l("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putLong(String str, long j) {
            ...
            if (arrayMap.containsKey(str) && ((Integer) arrayMap.get(str)).intValue() != 0) {
                throw new IllegalArgumentException(a.l("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (arrayMap.containsKey(str) && ((Integer) arrayMap.get(str)).intValue() != 3) {
                throw new IllegalArgumentException(a.l("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putString(String str, String str2) {
            ...
            if (arrayMap.containsKey(str) && ((Integer) arrayMap.get(str)).intValue() != 1) {
                throw new IllegalArgumentException(a.l("The ", str, " key cannot be used to put a String"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ArrayMap<String, Integer> arrayMap = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (arrayMap.containsKey(str) && ((Integer) arrayMap.get(str)).intValue() != 1) {
                throw new IllegalArgumentException(a.l("The ", str, " key cannot be used to put a CharSequence"));
            }
