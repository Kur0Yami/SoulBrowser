...
public class MediaSessionCompat {
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        VersionedParcelable session2Token = sessionToken.getSession2Token();
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private VolumeProviderCompat.Callback mVolumeCallback = new VolumeProviderCompat.Callback() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            ...
            public void onVolumeChanged(VolumeProviderCompat volumeProviderCompat) {
                ...
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, volumeProviderCompat.f1272a, volumeProviderCompat.b, volumeProviderCompat.d));
            }
        };
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (mediaSessionImplBase.mLock) {
                    try {
                        ...
                        int i4 = 2;
                        if (i2 == 2) {
                            i4 = volumeProviderCompat.f1272a;
                            i = volumeProviderCompat.b;
                            streamVolume = volumeProviderCompat.d;
                        } else {
        ...
        */
        ...
        public void setPlaybackToRemote(VolumeProviderCompat volumeProviderCompat) {
            if (volumeProviderCompat != null) {
                ...
                sendVolumeInfoChanged(new ParcelableVolumeInfo(i, i2, volumeProviderCompat3.f1272a, volumeProviderCompat3.b, volumeProviderCompat3.d));
                volumeProviderCompat.e = this.mVolumeCallback;
                return;
            }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            ...
            sb.append(", Id=");
            return android.support.v4.media.a.o(sb, this.mId, " }");
        }
    ...
    public static final class RegistrationCallbackHandler extends Handler {
        ...
        public void postCallbackRegistered(int i, int i2) {
            obtainMessage(MSG_CALLBACK_REGISTERED, i, i2).sendToTarget();
        }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            if (bundle != null) {
                ...
                VersionedParcelable a2 = ParcelUtils.a(bundle);
                Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
                if (token == null) {
                    return null;
                }
                return new Token(token.mInner, asInterface, a2);
            }
            return null;
        }
    ...
    public MediaSessionCompat(@NonNull Context context, @NonNull String str, @Nullable ComponentName componentName, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable VersionedParcelable versionedParcelable) {
        ...
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null) {
                    int i = MediaButtonReceiver.f1277a;
                    Intent intent = new Intent("android.intent.action.MEDIA_BUTTON");
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(VolumeProviderCompat volumeProviderCompat) {
            this.mSessionFwk.setPlaybackToRemote(volumeProviderCompat.a());
        }
