            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        ...
                        mediaControllerImplApi21.mSessionToken.setSession2Token(ParcelUtils.a(bundle));
        ...
        if (str != null) {
            if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
                if (bundle != null && bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                    ...
                    throw new IllegalArgumentException(android.support.v4.media.a.l("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
                }
            }
        }
    }
        ...
        */
        public PlaybackInfo(int r8, int r9, int r10, int r11, int r12) {
            /*
                ...
                androidx.media.AudioAttributesImpl$Builder r9 = r0.f1255a
                androidx.media.AudioAttributesImpl r9 = r9.build()
                r3.<init>(r9)
                r1 = r7
                r2 = r8
                r4 = r10
        ...
        public int getAudioStream() {
            return this.mAudioAttrsCompat.f1254a.a();
        }
