...
public class ListBookJava extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListBookJava listBookJava, long j, String str) {
            WeakReference weakReference = new WeakReference(listBookJava);
            this.e = weakReference;
            ListBookJava listBookJava2 = (ListBookJava) weakReference.get();
            if (listBookJava2 != null) {
                this.g = j;
                this.h = str;
                this.v = listBookJava2.d;
                this.w = listBookJava2.e;
                ListTask.ListTaskListener listTaskListener = listBookJava2.b;
        ...
        */
        public final void a() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.list.book.ListBookJava.ListTask.a():void");
        }

        @Override // com.mycompany.app.async.MyAsyncTask
        public final void d() {
            ListBookJava listBookJava;
            ListTask.ListTaskListener listTaskListener;
            WeakReference weakReference = this.e;
            if (weakReference == null || (listBookJava = (ListBookJava) weakReference.get()) == null) {
                return;
            }
            listBookJava.f16270c = null;
            if (this.f && (listTaskListener = listBookJava.b) != null) {
                listTaskListener.a();
            }
            this.h = null;
            this.i = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listBookJava = (ListBookJava) weakReference.get()) != null) {
                ...
                ListTask.ListTaskListener listTaskListener = listBookJava.b;
    ...
    public static void p(ListBookJava listBookJava, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public static void q(MainItem.ChildItem childItem) {
        ...
        if (PrefList.z0 == 0 && !TextUtils.isEmpty(childItem.h)) {
    ...
    public final void a() {
        ListTask listTask = this.f16270c;
        if (listTask != null) {
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        ...
        this.f16270c = listTask;
        listTask.b(this.f16269a);
    }
