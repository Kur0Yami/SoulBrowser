...
public class ListBookPop extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListBookPop listBookPop, long j, String str) {
            WeakReference weakReference = new WeakReference(listBookPop);
            this.e = weakReference;
            ListBookPop listBookPop2 = (ListBookPop) weakReference.get();
            if (listBookPop2 != null) {
                this.g = j;
                this.h = str;
                this.v = listBookPop2.d;
                this.w = listBookPop2.e;
                ListTask.ListTaskListener listTaskListener = listBookPop2.b;
        ...
        */
        public final void a() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.list.book.ListBookPop.ListTask.a():void");
        }
        ...
        public final void d() {
            ...
            if (weakReference == null || (listBookPop = (ListBookPop) weakReference.get()) == null) {
                return;
            }
            listBookPop.f16282c = null;
            if (this.f && (listTaskListener = listBookPop.b) != null) {
                listTaskListener.a();
            }
            this.h = null;
            this.i = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listBookPop = (ListBookPop) weakReference.get()) != null) {
                ...
                ListTask.ListTaskListener listTaskListener = listBookPop.b;
    ...
    public static void p(ListBookPop listBookPop, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public static void q(MainItem.ChildItem childItem) {
        ...
        if (PrefList.b0 == 0 && !TextUtils.isEmpty(childItem.h)) {
    ...
    public final void a() {
        ListTask listTask = this.f16282c;
        if (listTask != null) {
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        ...
        this.f16282c = listTask;
        listTask.b(this.f16281a);
    }
