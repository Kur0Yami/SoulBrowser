...
public class ListBookTmem extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListBookTmem listBookTmem, long j, String str) {
            WeakReference weakReference = new WeakReference(listBookTmem);
            this.e = weakReference;
            ListBookTmem listBookTmem2 = (ListBookTmem) weakReference.get();
            if (listBookTmem2 != null) {
                this.g = j;
                this.h = str;
                this.v = listBookTmem2.d;
                this.w = listBookTmem2.e;
                ListTask.ListTaskListener listTaskListener = listBookTmem2.b;
        ...
        */
        public final void a() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.list.book.ListBookTmem.ListTask.a():void");
        }

        @Override // com.mycompany.app.async.MyAsyncTask
        public final void d() {
            ListBookTmem listBookTmem;
            ListTask.ListTaskListener listTaskListener;
            WeakReference weakReference = this.e;
            if (weakReference == null || (listBookTmem = (ListBookTmem) weakReference.get()) == null) {
                return;
            }
            listBookTmem.f16290c = null;
            if (this.f && (listTaskListener = listBookTmem.b) != null) {
                listTaskListener.a();
            }
            this.h = null;
            this.i = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listBookTmem = (ListBookTmem) weakReference.get()) != null) {
                ...
                ListTask.ListTaskListener listTaskListener = listBookTmem.b;
    ...
    public static void p(ListBookTmem listBookTmem, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public static void q(MainItem.ChildItem childItem) {
        ...
        if (PrefList.I0 == 0 && !TextUtils.isEmpty(childItem.h)) {
    ...
    public final void a() {
        ListTask listTask = this.f16290c;
        if (listTask != null) {
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        ...
        this.f16290c = listTask;
        listTask.b(this.f16289a);
    }
