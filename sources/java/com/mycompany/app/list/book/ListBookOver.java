...
public class ListBookOver extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListBookOver listBookOver, long j, String str) {
            WeakReference weakReference = new WeakReference(listBookOver);
            this.e = weakReference;
            ListBookOver listBookOver2 = (ListBookOver) weakReference.get();
            if (listBookOver2 != null) {
                this.g = j;
                this.h = str;
                this.v = listBookOver2.d;
                this.w = listBookOver2.e;
                ListTask.ListTaskListener listTaskListener = listBookOver2.b;
        ...
        */
        public final void a() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.list.book.ListBookOver.ListTask.a():void");
        }

        @Override // com.mycompany.app.async.MyAsyncTask
        public final void d() {
            ListBookOver listBookOver;
            ListTask.ListTaskListener listTaskListener;
            WeakReference weakReference = this.e;
            if (weakReference == null || (listBookOver = (ListBookOver) weakReference.get()) == null) {
                return;
            }
            listBookOver.f16276c = null;
            if (this.f && (listTaskListener = listBookOver.b) != null) {
                listTaskListener.a();
            }
            this.h = null;
            this.i = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listBookOver = (ListBookOver) weakReference.get()) != null) {
                ...
                ListTask.ListTaskListener listTaskListener = listBookOver.b;
    ...
    public static void p(ListBookOver listBookOver, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public static void q(MainItem.ChildItem childItem) {
        ...
        if (PrefList.W == 0 && !TextUtils.isEmpty(childItem.h)) {
    ...
    public final void a() {
        ListTask listTask = this.f16276c;
        if (listTask != null) {
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        ...
        this.f16276c = listTask;
        listTask.b(this.f16275a);
    }
