...
public class ListBookCmp extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListBookCmp listBookCmp, long j, String str) {
            WeakReference weakReference = new WeakReference(listBookCmp);
            this.e = weakReference;
            ListBookCmp listBookCmp2 = (ListBookCmp) weakReference.get();
            if (listBookCmp2 != null) {
                this.g = j;
                this.h = str;
                this.v = listBookCmp2.d;
                this.w = listBookCmp2.e;
                ListTask.ListTaskListener listTaskListener = listBookCmp2.b;
        ...
        */
        public final void a() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.list.book.ListBookCmp.ListTask.a():void");
        }

        @Override // com.mycompany.app.async.MyAsyncTask
        public final void d() {
            ListBookCmp listBookCmp;
            ListTask.ListTaskListener listTaskListener;
            WeakReference weakReference = this.e;
            if (weakReference == null || (listBookCmp = (ListBookCmp) weakReference.get()) == null) {
                return;
            }
            listBookCmp.f16260c = null;
            if (this.f && (listTaskListener = listBookCmp.b) != null) {
                listTaskListener.a();
            }
            this.h = null;
            this.i = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listBookCmp = (ListBookCmp) weakReference.get()) != null) {
                ...
                ListTask.ListTaskListener listTaskListener = listBookCmp.b;
    ...
    public static void p(ListBookCmp listBookCmp, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public final void a() {
        ListTask listTask = this.f16260c;
        if (listTask != null) {
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        ...
        this.f16260c = listTask;
        listTask.b(this.f16259a);
    }
