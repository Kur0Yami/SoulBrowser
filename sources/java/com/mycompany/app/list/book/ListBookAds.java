...
public class ListBookAds extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListBookAds listBookAds, long j, String str) {
            WeakReference weakReference = new WeakReference(listBookAds);
            this.e = weakReference;
            ListBookAds listBookAds2 = (ListBookAds) weakReference.get();
            if (listBookAds2 != null) {
                this.g = j;
                this.h = str;
                this.v = listBookAds2.d;
                this.w = listBookAds2.e;
                ListTask.ListTaskListener listTaskListener = listBookAds2.b;
        ...
        */
        public final void a() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.list.book.ListBookAds.ListTask.a():void");
        }
        ...
        public final void d() {
            ...
            if (weakReference == null || (listBookAds = (ListBookAds) weakReference.get()) == null) {
                return;
            }
            listBookAds.f16252c = null;
            if (this.f && (listTaskListener = listBookAds.b) != null) {
                listTaskListener.a();
            }
            this.h = null;
            this.i = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listBookAds = (ListBookAds) weakReference.get()) != null) {
                ...
                ListTask.ListTaskListener listTaskListener = listBookAds.b;
    ...
    public static void p(ListBookAds listBookAds, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public static void q(MainItem.ChildItem childItem) {
        ...
        if (PrefList.R == 0 && !TextUtils.isEmpty(childItem.h)) {
    ...
    public final void a() {
        ListTask listTask = this.f16252c;
        if (listTask != null) {
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        ...
        this.f16252c = listTask;
        listTask.b(this.f16251a);
    }
