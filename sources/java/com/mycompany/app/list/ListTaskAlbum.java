...
public class ListTaskAlbum extends com.mycompany.app.list.ListTask {
    ...
    public static class ListTask extends MyAsyncTask {
        ...
        public ListTask(ListTaskAlbum listTaskAlbum, boolean z, boolean z2, String str, boolean z3, List list, List list2) {
            ...
            if (listTaskAlbum2 != null) {
                ...
                this.o = list;
                this.u = list2;
                this.A = listTaskAlbum2.i;
                this.B = listTaskAlbum2.j;
                this.y = listTaskAlbum2.g;
                listTaskAlbum2.g = false;
                ListTask.ListTaskListener listTaskListener = listTaskAlbum2.b;
        ...
        */
        ...
        public final void d() {
            ...
            listTaskAlbum.f16241c = null;
            if (this.f && (listTaskListener = listTaskAlbum.b) != null) {
                listTaskListener.a();
            }
            this.i = null;
            this.j = null;
        ...
        public final void e() {
            ...
            if (weakReference != null && (listTaskAlbum = (ListTaskAlbum) weakReference.get()) != null) {
                ...
                if (listTaskAlbum.e) {
                    listTaskAlbum.g(listTaskAlbum.f);
                }
                ListTask.ListTaskListener listTaskListener = listTaskAlbum.b;
    ...
    public static class SaveTask extends MyAsyncTask {
        ...
        public SaveTask(ListTaskAlbum listTaskAlbum, List list) {
            WeakReference weakReference = new WeakReference(listTaskAlbum);
            this.e = weakReference;
        ...
        public final void a() {
            ...
            List list;
            WeakReference weakReference = this.e;
            if (weakReference != null && (listTaskAlbum = (ListTaskAlbum) weakReference.get()) != null && !this.f12839c && (list = this.f) != null && !list.isEmpty()) {
                for (MainUri.UriItem uriItem : this.f) {
                    if (!this.f12839c) {
                        if (uriItem != null) {
                            DataUtil.b(listTaskAlbum.f16240a, uriItem);
                        }
                    } else {
                        return;
                    }
    ...
    public ListTaskAlbum(Context context, ListTask.ListTaskListener listTaskListener) {
    ...
    public static void p(ListTaskAlbum listTaskAlbum, ArrayList arrayList, String str, int i, int i2, int i3) {
        if (arrayList == null) {
            return;
        }
        ?? obj = new Object();
    ...
    public static MainItem.ChildItem r(MainUri.UriItem uriItem) {
        ...
        obj.f = uriItem.d;
        obj.g = uriItem.e;
        obj.h = MainUtil.k1(uriItem.f);
        obj.A = uriItem.g;
        obj.B = uriItem.h;
        obj.f16551c = 4;
        obj.v = -460552;
        obj.w = R.drawable.outline_local_library_black_24;
        s(obj);
        return obj;
    }
    ...
    public final void a() {
        ListTask listTask = this.f16241c;
        if (listTask != null) {
    ...
    public final void g(boolean z) {
        ...
        ListScan.ListScanListener listScanListener = new ListScan.ListScanListener() { // from class: com.mycompany.app.list.ListTaskAlbum.1
            @Override // com.mycompany.app.list.ListScan.ListScanListener
            public final void b() {
                ListTaskAlbum listTaskAlbum = ListTaskAlbum.this;
                listTaskAlbum.d = null;
                Context context = listTaskAlbum.f16240a;
                if (context != null) {
                    ArrayList arrayList = DataAlbum.m(context).f12896c;
                    DataAlbum.m(context).f12896c = null;
                    if (!ListTaskAlbum.k) {
                        listTaskAlbum.q(false, true, null, false, arrayList, null);
                    }
                    ListTaskAlbum.k = false;
                    if (arrayList != null && !arrayList.isEmpty()) {
                        SaveTask saveTask = listTaskAlbum.h;
                        if (saveTask != null) {
                            saveTask.f12839c = true;
                        }
                        listTaskAlbum.h = null;
                        SaveTask saveTask2 = new SaveTask(listTaskAlbum, arrayList);
                        listTaskAlbum.h = saveTask2;
                        saveTask2.b(context);
                    }
                }
                ListTask.ListTaskListener listTaskListener = listTaskAlbum.b;
        ...
        ListScan listScan2 = new ListScan(context, 1, z, listScanListener);
        this.d = listScan2;
    ...
    public final void i(boolean z, boolean z2, boolean z3) {
        boolean z4;
        if (z && !TextUtils.isEmpty(PrefPath.s)) {
            z4 = true;
        } else {
            z4 = false;
        }
    ...
    public final void j(String str) {
        ...
        this.f16241c = listTask;
        listTask.b(this.f16240a);
    }
