...
public class DbBookTmem extends SQLiteOpenHelper {

    /* renamed from: c, reason: collision with root package name */
    public static DbBookTmem f12961c;
    ...
    */
    public static java.io.File a(android.content.Context r13, java.lang.String r14) {
        ...
        L11:
            r4 = 0
            com.mycompany.app.db.book.DbBookTmem r13 = b(r13)     // Catch: java.lang.Exception -> L84
            android.database.sqlite.SQLiteDatabase r5 = r13.getWritableDatabase()     // Catch: java.lang.Exception -> L84
            java.lang.String r6 = "DbBookTmem_table"
            r9 = 0
            r10 = 0
            r7 = 0
            r8 = 0
        ...
        Lad:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.db.book.DbBookTmem.a(android.content.Context, java.lang.String):java.io.File");
    }

    /* JADX WARN: Type inference failed for: r1v1, types: [android.database.sqlite.SQLiteOpenHelper, com.mycompany.app.db.book.DbBookTmem] */
    public static DbBookTmem b(Context context) {
        if (f12961c == null) {
            synchronized (DbBookTmem.class) {
                try {
                    if (f12961c == null) {
                        f12961c = new SQLiteOpenHelper(MainUtil.R(context), "DbBookTmem.db", (SQLiteDatabase.CursorFactory) null, 1);
                    }
                } finally {
                }
            }
    ...
    */
    public static com.mycompany.app.main.MainItem.ChildItem d(android.content.Context r11, java.lang.String r12) {
        ...
        Lb:
            ...
            com.mycompany.app.db.book.DbBookTmem r11 = b(r11)
            android.database.sqlite.SQLiteDatabase r3 = r11.getWritableDatabase()
            java.lang.String r11 = "DbBookTmem_table"
        ...
        L3e:
            ...
            r9 = 0
            java.lang.String r4 = "DbBookTmem_table"
            r8 = 0
        ...
        L92:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.db.book.DbBookTmem.d(android.content.Context, java.lang.String):com.mycompany.app.main.MainItem$ChildItem");
    }

    @Override // android.database.sqlite.SQLiteOpenHelper
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        sQLiteDatabase.execSQL("CREATE TABLE DbBookTmem_table (_id INTEGER PRIMARY KEY, _path TEXT, _title TEXT, _icon BLOB, _time INTEGER, _rsv1 TEXT, _rsv2 TEXT, _rsv3 TEXT, _rsv4 INTEGER, _rsv5 INTEGER, _rsv6 INTEGER);");
    }

    @Override // android.database.sqlite.SQLiteOpenHelper
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        sQLiteDatabase.execSQL("DROP TABLE IF EXISTS DbBookTmem_table");
        sQLiteDatabase.execSQL("CREATE TABLE DbBookTmem_table (_id INTEGER PRIMARY KEY, _path TEXT, _title TEXT, _icon BLOB, _time INTEGER, _rsv1 TEXT, _rsv2 TEXT, _rsv3 TEXT, _rsv4 INTEGER, _rsv5 INTEGER, _rsv6 INTEGER);");
    }
}
