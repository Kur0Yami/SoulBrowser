...
public class DbBookLink extends SQLiteOpenHelper {

    /* renamed from: c, reason: collision with root package name */
    public static DbBookLink f12935c;

    /* JADX WARN: Type inference failed for: r1v1, types: [android.database.sqlite.SQLiteOpenHelper, com.mycompany.app.db.book.DbBookLink] */
    public static DbBookLink a(Context context) {
        if (f12935c == null) {
            synchronized (DbBookLink.class) {
                try {
                    if (f12935c == null) {
                        f12935c = new SQLiteOpenHelper(MainUtil.R(context), "DbBookLink.db", (SQLiteDatabase.CursorFactory) null, 1);
                    }
                } finally {
                }
            }
    ...
    */
    public static com.mycompany.app.main.MainItem.ChildItem b(android.content.Context r11, java.lang.String r12) {
        ...
        Lb:
            ...
            com.mycompany.app.db.book.DbBookLink r11 = a(r11)
            android.database.sqlite.SQLiteDatabase r3 = r11.getWritableDatabase()
            java.lang.String r11 = "DbBookLink_table"
        ...
        L3e:
            ...
            r9 = 0
            java.lang.String r4 = "DbBookLink_table"
            r8 = 0
        ...
        L92:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.db.book.DbBookLink.b(android.content.Context, java.lang.String):com.mycompany.app.main.MainItem$ChildItem");
    }

    @Override // android.database.sqlite.SQLiteOpenHelper
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        sQLiteDatabase.execSQL("CREATE TABLE DbBookLink_table (_id INTEGER PRIMARY KEY, _path TEXT, _title TEXT, _icon BLOB, _time INTEGER, _rsv1 TEXT, _rsv2 TEXT, _rsv3 TEXT, _rsv4 INTEGER, _rsv5 INTEGER, _rsv6 INTEGER);");
    }

    @Override // android.database.sqlite.SQLiteOpenHelper
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        sQLiteDatabase.execSQL("DROP TABLE IF EXISTS DbBookLink_table");
        sQLiteDatabase.execSQL("CREATE TABLE DbBookLink_table (_id INTEGER PRIMARY KEY, _path TEXT, _title TEXT, _icon BLOB, _time INTEGER, _rsv1 TEXT, _rsv2 TEXT, _rsv3 TEXT, _rsv4 INTEGER, _rsv5 INTEGER, _rsv6 INTEGER);");
    }
}
