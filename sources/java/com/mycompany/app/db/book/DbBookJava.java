...
public class DbBookJava extends SQLiteOpenHelper {
    ...
    public static DbBookJava f12934c;

    /* JADX WARN: Type inference failed for: r1v1, types: [android.database.sqlite.SQLiteOpenHelper, com.mycompany.app.db.book.DbBookJava] */
    public static DbBookJava a(Context context) {
        if (f12934c == null) {
            synchronized (DbBookJava.class) {
                try {
                    if (f12934c == null) {
                        f12934c = new SQLiteOpenHelper(MainUtil.R(context), "DbBookJava.db", (SQLiteDatabase.CursorFactory) null, 2);
                    }
                } finally {
                }
            }
    ...
    */
    public static com.mycompany.app.main.MainItem.ChildItem b(android.content.Context r11, java.lang.String r12) {
        ...
        Lb:
            ...
            com.mycompany.app.db.book.DbBookJava r11 = a(r11)
            android.database.sqlite.SQLiteDatabase r3 = r11.getWritableDatabase()
            java.lang.String r11 = "DbBookJava_table"
