...
public class DbBookCmp extends SQLiteOpenHelper {
    ...
    public static DbBookCmp f12928c;

    /* JADX WARN: Type inference failed for: r1v1, types: [android.database.sqlite.SQLiteOpenHelper, com.mycompany.app.db.book.DbBookCmp] */
    public static DbBookCmp a(Context context) {
        if (f12928c == null) {
            synchronized (DbBookCmp.class) {
                try {
                    if (f12928c == null) {
                        f12928c = new SQLiteOpenHelper(MainUtil.R(context), "DbBookCmp.db", (SQLiteDatabase.CursorFactory) null, 2);
                    }
                } finally {
                }
            }
    ...
    */
    public static com.mycompany.app.main.MainItem.ChildItem b(android.content.Context r18, java.lang.String r19, java.lang.String r20, int r21, int r22, int r23, android.graphics.Bitmap r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mycompany.app.db.book.DbBookCmp.b(android.content.Context, java.lang.String, java.lang.String, int, int, int, android.graphics.Bitmap):com.mycompany.app.main.MainItem$ChildItem");
    }
