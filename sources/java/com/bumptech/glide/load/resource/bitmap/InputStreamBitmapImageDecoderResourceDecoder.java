...
public final class InputStreamBitmapImageDecoderResourceDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    public final BitmapImageDecoderResourceDecoder f2374a = new BitmapImageDecoderResourceDecoder();
    ...
    public final Resource b(Object obj, int i, int i2, Options options) {
        return this.f2374a.c(ImageDecoder.createSource(ByteBufferUtil.b((InputStream) obj)), i, i2, options);
    }
}
