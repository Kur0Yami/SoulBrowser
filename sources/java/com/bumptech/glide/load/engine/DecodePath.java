...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    public final Class f2202a;
    public final List b;

    /* renamed from: c, reason: collision with root package name */
    public final ResourceTranscoder f2203c;
    ...
    public DecodePath(Class cls, Class cls2, Class cls3, List list, ResourceTranscoder resourceTranscoder, Pools.Pool pool) {
        this.f2202a = cls;
        this.b = list;
        this.f2203c = resourceTranscoder;
        this.d = pool;
    ...
    public final String toString() {
        return "DecodePath{ dataClass=" + this.f2202a + ", decoders=" + this.b + ", transcoder=" + this.f2203c + '}';
    }
}
