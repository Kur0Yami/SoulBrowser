...
final class zzcb extends com.google.android.gms.internal.play_billing.zzah {
    ...
    public final void b(Bundle bundle) {
            ...
            if (bundle.containsKey("RESPONSE_CODE")) {
                ...
                if (a2 == 0) {
                    if (((PendingIntent) bundle.getParcelable("EXTERNAL_PAYMENT_DIALOG_INTENT")) == null) {
                        com.google.android.gms.internal.play_billing.zzc.i("BillingClient", "Pending intent not found in response bundle.");
                    ...
                    try {
                        ...
                        com.google.android.gms.internal.play_billing.zzc.j("BillingClient", "Runtime error while launching intent for launch external link dialog.", e);
                ...
                com.google.android.gms.internal.play_billing.zzc.i("BillingClient", "Unable to launch intent for launch external link dialog. Response code: " + a2);
                throw null;
            }
        ...
        com.google.android.gms.internal.play_billing.zzc.i("BillingClient", "Response bundle is null.");
        BillingResult billingResult2 = zzdb.f2064a;
        throw null;
    }
}
