...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public final void onSharedElementEnd(List list, List list2, List list3) {
        ...
        if (!list2.isEmpty()) {
            ...
            this.f12056a = new Rect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
        }
    }
    ...
    public final void onSharedElementStart(List list, List list2, List list3) {
        ...
        if (!list2.isEmpty() && this.f12056a != null) {
            View view = (View) list2.get(0);
            view.measure(View.MeasureSpec.makeMeasureSpec(this.f12056a.width(), 1073741824), View.MeasureSpec.makeMeasureSpec(this.f12056a.height(), 1073741824));
            Rect rect = this.f12056a;
