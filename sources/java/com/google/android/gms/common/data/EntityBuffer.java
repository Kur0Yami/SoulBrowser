...
public abstract class EntityBuffer<T> extends AbstractDataBuffer<T> {
    ...
    public final int zaa(int i) {
        ...
        throw new IllegalArgumentException(androidx.work.impl.workers.a.t(new StringBuilder(String.valueOf(i).length() + 42), "Position ", i, " is out of bounds for this buffer"));
    }
}
