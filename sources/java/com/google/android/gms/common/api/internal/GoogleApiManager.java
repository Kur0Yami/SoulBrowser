...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final void zaI(TaskCompletionSource taskCompletionSource, int i, GoogleApi googleApi) {
        ...
        if (i != 0 && (zaa2 = zaby.zaa(this, i, googleApi.getApiKey())) != null) {
            zzw zzwVar = taskCompletionSource.f11605a;
            final Handler handler = this.zas;
            Objects.requireNonNull(handler);
            zzwVar.d(new Executor() { // from class: com.google.android.gms.common.api.internal.zabp
    ...
    public static Status zaJ(ApiKey apiKey, ConnectionResult connectionResult) {
        ...
        return new Status(connectionResult, a.r(new StringBuilder(String.valueOf(zaa2).length() + 63 + valueOf.length()), "API: ", zaa2, " is not available on this device. Connection failed with: ", valueOf));
    }
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabkVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        ...
                        zabkVar.zav(new Status(17, a.r(new StringBuilder(String.valueOf(errorString).length() + 69 + String.valueOf(errorMessage).length()), "Error resolution was canceled by the user, original error message: ", errorString, ": ", errorMessage)));
                    } else {
                        zabkVar.zav(zaJ(zabkVar.zaA(), connectionResult));
                    }
                } else {
                    Log.wtf("GoogleApiManager", androidx.work.impl.workers.a.t(new StringBuilder(String.valueOf(i2).length() + 65), "Could not find API instance ", i2, " while trying to fail enqueued calls."), new Exception());
                }
                return true;
            case 6:
            ...
            case 14:
                ...
                if (!map5.containsKey(zaa2)) {
                    zaacVar.zab().b(Boolean.FALSE);
                } else {
                    zaacVar.zab().b(Boolean.valueOf(((zabk) map5.get(zaa2)).zaw(false)));
                }
                return true;
            case 15:
