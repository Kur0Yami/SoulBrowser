...
public final class zaar implements zaba {
    ...
    private final void zaB() {
        ...
        if (zaeVar != null) {
            if (this.zap) {
                zaeVar.a((IAccountAccessor) Preconditions.checkNotNull(this.zao), this.zaq);
            }
            zaG(false);
        }
    ...
    private final boolean zaI(int i) {
        if (this.zag != i) {
            ...
            String zaJ2 = zaJ(i);
            Log.e("GACConnecting", a.r(new StringBuilder(zaJ2.length() + zaJ.length() + 70), "GoogleApiClient connecting is in step ", zaJ, " but received callback for step ", zaJ2), new Exception());
    ...
    public final void zaj(com.google.android.gms.signin.internal.zak zakVar) {
        ...
        if (connectionResult.isSuccess()) {
            com.google.android.gms.common.internal.zav zavVar = (com.google.android.gms.common.internal.zav) Preconditions.checkNotNull(zakVar.g);
