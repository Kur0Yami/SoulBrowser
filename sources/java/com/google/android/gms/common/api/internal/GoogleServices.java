...
public final class GoogleServices {
    ...
    public Status checkGoogleAppId(String str) {
        ...
        if (str2 != null && !str2.equals(str)) {
            return new Status(10, a.q(new StringBuilder(str2.length() + 97), "Initialize was called with two different Google App IDs.  Only the first app ID will be used: '", str2, "'."));
        }
