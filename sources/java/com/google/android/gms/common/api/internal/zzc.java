...
public final class zzc {
    private final Map zza = DesugarCollections.synchronizedMap(new SimpleArrayMap(0));
    private int zzb = 0;
    ...
    public final void zzb(String str, LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(a.q(new StringBuilder(String.valueOf(str).length() + 59), "LifecycleCallback with tag ", str, " already added to this fragment."));
    }
