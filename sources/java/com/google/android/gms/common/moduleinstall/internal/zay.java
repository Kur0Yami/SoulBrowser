...
public final class zay extends GoogleApi implements ModuleInstallClient {
    ...
    public final Task<ModuleAvailabilityResponse> areModulesAvailable(OptionalModuleApi... optionalModuleApiArr) {
        ...
        builder.setFeatures(com.google.android.gms.internal.base.zap.f9601a);
    ...
    public final Task<ModuleInstallIntentResponse> getInstallModulesIntent(OptionalModuleApi... optionalModuleApiArr) {
        ...
        if (zad2.getApiFeatures().isEmpty()) {
            return Tasks.e(new ModuleInstallIntentResponse(null));
        }
        TaskApiCall.Builder builder = TaskApiCall.builder();
        builder.setFeatures(com.google.android.gms.internal.base.zap.f9601a);
    ...
    public final Task<ModuleInstallResponse> installModules(ModuleInstallRequest moduleInstallRequest) {
        ...
        if (fromModuleInstallRequest.getApiFeatures().isEmpty()) {
            return Tasks.e(new ModuleInstallResponse(0));
        }
        if (listener == null) {
            TaskApiCall.Builder builder = TaskApiCall.builder();
            builder.setFeatures(com.google.android.gms.internal.base.zap.f9601a);
        ...
        builder2.setFeatures(com.google.android.gms.internal.base.zap.f9601a);
        ...
        return doRegisterEventListener(builder2.build()).q(new SuccessContinuation() { // from class: com.google.android.gms.common.moduleinstall.internal.zau
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final /* synthetic */ Task then(Object obj) {
                int i = zay.zab;
                AtomicReference atomicReference2 = atomicReference;
                if (atomicReference2.get() != null) {
                    return Tasks.e((ModuleInstallResponse) atomicReference2.get());
                }
                return Tasks.d(new ApiException(Status.RESULT_INTERNAL_ERROR));
            }
        });
    }
