    ...
    public final boolean zza() {
        try {
            ...
            if (!baseGmsClient.getServiceDescriptor().equals(interfaceDescriptor)) {
                ...
                Log.w("GmsClient", a.r(new StringBuilder(String.valueOf(serviceDescriptor).length() + 34 + String.valueOf(interfaceDescriptor).length()), "service descriptor mismatch: ", serviceDescriptor, " vs. ", interfaceDescriptor));
                return false;
            }
