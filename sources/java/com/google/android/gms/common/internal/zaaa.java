...
public final class zaaa extends Button {
    ...
    private static final int zab(int i, int i2, int i3, int i4) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalStateException(a.r(i, "Unknown color scheme: ", new StringBuilder(String.valueOf(i).length() + 22)));
            }
            return i3;
        }
        return i2;
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        if (i != 0 && i != 1) {
            if (i != 2) {
                StringBuilder sb = new StringBuilder(a.a(i, 21));
        ...
        if (i != 0) {
            if (i != 1) {
                if (i == 2) {
                    ...
                    StringBuilder sb2 = new StringBuilder(a.a(i, 21));
