...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        if (parcel.dataPosition() == i) {
            ...
            throw new ParseException(a.r(i, "Overread allowed size end=", new StringBuilder(String.valueOf(i).length() + 26)), parcel);
        }
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            throw new ParseException(com.mycompany.app.dialog.a.m(new StringBuilder(String.valueOf(dataPosition).length() + 32 + String.valueOf(i).length()), "Size read is invalid start=", dataPosition, " end=", i), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        a.A(sb, "Expected size ", i2, " got ", readSize);
        throw new ParseException(android.support.v4.media.a.q(sb, " (0x", hexString, ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2, int i3) {
        ...
        a.A(sb, "Expected size ", i3, " got ", i2);
        throw new ParseException(android.support.v4.media.a.q(sb, " (0x", hexString, ")"), parcel);
    }
}
