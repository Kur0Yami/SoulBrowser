...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, @Nullable Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(a.r(i, "Unsupported type for conversion: ", new StringBuilder(String.valueOf(i).length() + 33)));
            case 4:
                if (zah != null) {
    ...
    public Object getFieldValue(@NonNull Field field) {
        ...
        if (field.zag != null) {
            ...
            Preconditions.checkState(z, "Concrete field shouldn't be value object: %s", str);
            try {
