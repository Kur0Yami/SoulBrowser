...
public final class zzl extends RemoteCreator {
    ...
    @Nullable
    public final zzck zza(Context context, zzbsz zzbszVar) {
        try {
            IBinder zze = ((zzcl) getRemoteCreatorInstance(context)).zze(new ObjectWrapper(context), zzbszVar, ModuleDescriptor.MODULE_VERSION);
            if (zze == null) {
                return null;
            }
