...
public final class zzi extends RemoteCreator {
    ...
    @Nullable
    public final zzbt zza(Context context, String str, zzbsz zzbszVar) {
        try {
            IBinder zze = ((zzbu) getRemoteCreatorInstance(context)).zze(new ObjectWrapper(context), str, zzbszVar, ModuleDescriptor.MODULE_VERSION);
            if (zze == null) {
                return null;
            }
