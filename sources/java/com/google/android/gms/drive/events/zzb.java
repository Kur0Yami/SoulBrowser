...
public final class zzb extends AbstractSafeParcelable implements DriveEvent {
    ...
    public final boolean equals(Object obj) {
        if (obj != null && obj.getClass() == zzb.class) {
            ...
            return Objects.equal(this.f3691c, ((zzb) obj).f3691c);
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hashCode(this.f3691c);
    }

    public final String toString() {
        Locale locale = Locale.US;
        return "ChangesAvailableEvent [changesAvailableOptions=" + this.f3691c + "]";
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        int beginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeParcelable(parcel, 3, this.f3691c, i, false);
