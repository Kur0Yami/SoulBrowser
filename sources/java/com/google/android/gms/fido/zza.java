...
public final class zza {
    ...
    public static final Feature f3816a;
    public static final Feature b;

    /* renamed from: c, reason: collision with root package name */
    public static final Feature f3817c;
    ...
    static {
        ...
        f3816a = new Feature("is_user_verifying_platform_authenticator_available_for_credential", 1L);
        b = new Feature("is_user_verifying_platform_authenticator_available", 1L);
        f3817c = new Feature("privileged_api_list_credentials", 2L);
