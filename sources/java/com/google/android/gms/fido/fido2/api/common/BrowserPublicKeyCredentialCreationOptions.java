...
public class BrowserPublicKeyCredentialCreationOptions extends BrowserRequestOptions {
    ...
    public final PublicKeyCredentialCreationOptions f3751c;
    public final Uri f;
    public final byte[] g;
    ...
    public BrowserPublicKeyCredentialCreationOptions(PublicKeyCredentialCreationOptions publicKeyCredentialCreationOptions, Uri uri, byte[] bArr) {
        boolean z;
        boolean z2;
        this.f3751c = (PublicKeyCredentialCreationOptions) Preconditions.checkNotNull(publicKeyCredentialCreationOptions);
    ...
    public final boolean equals(Object obj) {
        ...
        if (!Objects.equal(this.f3751c, browserPublicKeyCredentialCreationOptions.f3751c) || !Objects.equal(this.f, browserPublicKeyCredentialCreationOptions.f)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Objects.hashCode(this.f3751c, this.f);
    }

    public final String toString() {
        String valueOf = String.valueOf(this.f3751c);
        String valueOf2 = String.valueOf(this.f);
        return a.p(androidx.work.impl.workers.a.u("BrowserPublicKeyCredentialCreationOptions{\n publicKeyCredentialCreationOptions=", valueOf, ", \n origin=", valueOf2, ", \n clientDataHash="), Base64Utils.encodeUrlSafeNoPadding(this.g), "}");
    }

    @Override // android.os.Parcelable
    public final void writeToParcel(Parcel parcel, int i) {
        int beginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeParcelable(parcel, 2, this.f3751c, i, false);
