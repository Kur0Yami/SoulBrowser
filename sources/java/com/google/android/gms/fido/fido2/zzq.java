...
final class zzq extends com.google.android.gms.internal.fido.zzl {
    ...
    public final /* synthetic */ TaskCompletionSource f3794c;

    public zzq(TaskCompletionSource taskCompletionSource) {
        this.f3794c = taskCompletionSource;
    }

    @Override // com.google.android.gms.internal.fido.zzm
    public final void o(Status status, PendingIntent pendingIntent) {
        TaskUtil.setResultOrApiException(status, pendingIntent, (TaskCompletionSource<PendingIntent>) this.f3794c);
    }
}
