...
final class zzt extends com.google.android.gms.internal.fido.zzl {
    ...
    public final /* synthetic */ TaskCompletionSource f3797c;

    public zzt(TaskCompletionSource taskCompletionSource) {
        this.f3797c = taskCompletionSource;
    }

    @Override // com.google.android.gms.internal.fido.zzm
    public final void o(Status status, PendingIntent pendingIntent) {
        TaskUtil.setResultOrApiException(status, new Object(), (TaskCompletionSource<Object>) this.f3797c);
    }
}
