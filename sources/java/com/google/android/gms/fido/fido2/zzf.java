...
final class zzf extends com.google.android.gms.internal.fido.zzq {
    ...
    public final /* synthetic */ TaskCompletionSource f3789c;

    public zzf(TaskCompletionSource taskCompletionSource) {
        this.f3789c = taskCompletionSource;
    }

    @Override // com.google.android.gms.internal.fido.zzr
    public final void o(Status status, PendingIntent pendingIntent) {
        TaskUtil.setResultOrApiException(status, pendingIntent, (TaskCompletionSource<PendingIntent>) this.f3789c);
    }
}
