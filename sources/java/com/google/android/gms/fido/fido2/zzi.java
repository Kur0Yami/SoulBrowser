...
final class zzi extends com.google.android.gms.internal.fido.zzq {
    ...
    public final /* synthetic */ TaskCompletionSource f3792c;

    public zzi(TaskCompletionSource taskCompletionSource) {
        this.f3792c = taskCompletionSource;
    }

    @Override // com.google.android.gms.internal.fido.zzr
    public final void o(Status status, PendingIntent pendingIntent) {
        TaskUtil.setResultOrApiException(status, new Object(), (TaskCompletionSource<Object>) this.f3792c);
    }
}
