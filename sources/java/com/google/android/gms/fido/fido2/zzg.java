...
final class zzg extends com.google.android.gms.internal.fido.zzq {
    ...
    public final /* synthetic */ TaskCompletionSource f3790c;

    public zzg(TaskCompletionSource taskCompletionSource) {
        this.f3790c = taskCompletionSource;
    }

    @Override // com.google.android.gms.internal.fido.zzr
    public final void o(Status status, PendingIntent pendingIntent) {
        TaskUtil.setResultOrApiException(status, pendingIntent, (TaskCompletionSource<PendingIntent>) this.f3790c);
    }
}
