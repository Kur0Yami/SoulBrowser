...
public final class zzxx {
    public static final zzxx f;
    public static final zzxx g;
    public static final zzxx[] h;
    public static final /* synthetic */ zzxx[] i;
    ...
    static {
        ...
        g = zzxxVar49;
        i = new zzxx[]{zzxxVar, zzxxVar2, zzxxVar3, zzxxVar4, zzxxVar5, zzxxVar6, zzxxVar7, zzxxVar8, zzxxVar9, zzxxVar10, zzxxVar11, zzxxVar12, zzxxVar13, zzxxVar14, zzxxVar15, zzxxVar16, zzxxVar17, zzxxVar18, zzxxVar19, zzxxVar20, zzxxVar21, zzxxVar22, zzxxVar23, zzxxVar24, zzxxVar25, zzxxVar26, zzxxVar27, zzxxVar28, zzxxVar29, zzxxVar30, zzxxVar31, zzxxVar32, zzxxVar33, zzxxVar34, zzxxVar35, zzxxVar36, zzxxVar37, zzxxVar38, zzxxVar39, zzxxVar40, zzxxVar41, zzxxVar42, zzxxVar43, zzxxVar44, zzxxVar45, zzxxVar46, zzxxVar47, zzxxVar48, zzxxVar49, new zzxx("GROUP_LIST", 49, 49, 2, zzypVar7), new zzxx("MAP", 50, 50, 4, zzyp.f9883c)};
        zzxx[] values = values();
        h = new zzxx[values.length];
        for (zzxx zzxxVar50 : values) {
            h[zzxxVar50.f9877c] = zzxxVar50;
        }
    }

    public zzxx(String str, int i2, int i3, int i4, zzyp zzypVar) {
        this.f9877c = i3;
        int i5 = i4 - 1;
        if (i5 != 1) {
            if (i5 == 3) {
