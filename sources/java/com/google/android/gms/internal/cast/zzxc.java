...
final class zzxc extends zzxa implements RandomAccess, zzyf {
    ...
    public zzxc(boolean[] zArr, int i, boolean z) {
        super(z);
        this.f = zArr;
        this.g = i;
    }
    ...
    public final void add(int i, Object obj) {
        ...
        if (i >= 0 && i <= (i2 = this.g)) {
            ...
            if (i2 < length) {
                ...
                boolean[] zArr2 = new boolean[com.google.android.gms.internal.ads.a.e(length, 3, 2, 1, 10)];
        ...
        throw new IndexOutOfBoundsException(zzxd.a(this.g, i, (byte) 13, "Index:", ", Size:"));
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzxcVar.f, 0, this.f, this.g, zzxcVar.g);
            this.g = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final zzyl zzf(int i) {
        ...
        if (i >= this.g) {
            ...
            return new zzxc(copyOf, this.g, true);
        }
    ...
    public final boolean add(Object obj) {
        ...
        if (i == length) {
            boolean[] zArr = new boolean[com.google.android.gms.internal.ads.a.e(length, 3, 2, 1, 10)];
