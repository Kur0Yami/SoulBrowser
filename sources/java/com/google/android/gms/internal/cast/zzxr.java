...
final class zzxr extends zzxa implements RandomAccess, zzyg {
    ...
    public zzxr(double[] dArr, int i, boolean z) {
        super(z);
        this.f = dArr;
        this.g = i;
    }
    ...
    public final void add(int i, Object obj) {
        ...
        if (i >= 0 && i <= (i2 = this.g)) {
            ...
            if (i2 < length) {
                ...
                double[] dArr2 = new double[com.google.android.gms.internal.ads.a.e(length, 3, 2, 1, 10)];
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzxrVar.f, 0, this.f, this.g, zzxrVar.g);
            this.g = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final zzyl zzf(int i) {
        ...
        if (i >= this.g) {
            ...
            return new zzxr(copyOf, this.g, true);
        }
    ...
    public final boolean add(Object obj) {
        ...
        if (i == length) {
            double[] dArr = new double[com.google.android.gms.internal.ads.a.e(length, 3, 2, 1, 10)];
