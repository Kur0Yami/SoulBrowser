...
public final class zzhqw extends zziar implements zzicd {
    private static final zzhqw zzc;
    ...
    static {
        ...
        zzc = zzhqwVar;
        zziar.x(zzhqw.class, zzhqwVar);
    }

    public static zzhqw F(zzhzl zzhzlVar, zziab zziabVar) {
        return (zzhqw) zziar.r(zzc, zzhzlVar, zziabVar);
    }

    public static zzhqv G() {
        return (zzhqv) zzc.u();
    }
