...
public final class zzhsx {
    ...
    public zzhta f8747a = null;
    public zzhxd b = null;

    /* renamed from: c, reason: collision with root package name */
    public zzhxd f8748c = null;
    public zzhxd d = null;
    public zzhxd e = null;
    public zzhxd f = null;
    public zzhxd g = null;

    public final zzhsy a() {
        zzhxd zzhxdVar;
        zzhxd zzhxdVar2;
        zzhta zzhtaVar = this.f8747a;
        if (zzhtaVar != null) {
            zzhxd zzhxdVar3 = this.f8748c;
            if (zzhxdVar3 != null && (zzhxdVar = this.d) != null) {
                ...
                if (zzhxdVar4 != null) {
                    ...
                    if (zzhxdVar5 != null && (zzhxdVar2 = this.f) != null) {
                        ...
                        if (zzhxdVar6 != null) {
                            BigInteger bigInteger = zzhtaVar.f8754a.b;
                            BigInteger bigInteger2 = zzhtaVar.b;
                                            ...
                                            if (bigInteger.multiply(bigInteger6).mod(subtract).equals(bigInteger9)) {
                                                if (bigInteger.multiply(bigInteger7).mod(subtract2).equals(bigInteger9)) {
                                                    if (bigInteger4.multiply(bigInteger8).mod(bigInteger3).equals(bigInteger9)) {
                                                        return new zzhsy(this.f8747a, this.f8748c, this.d, this.b, this.e, this.f, this.g);
                                                    }
