...
public final class zzhht {
    ...
    public static final int[] f8562a = {0, 3, 6, 9, 12, 16, 19, 22, 25, 28};
    public static final int[] b = {0, 2, 3, 5, 6, 0, 1, 3, 4, 6};

    /* renamed from: c, reason: collision with root package name */
    public static final int[] f8563c = {67108863, 33554431};
    ...
    public static long[] g(byte[] bArr) {
        ...
        for (int i = 0; i < 10; i++) {
            int i2 = f8562a[i];
            jArr[i] = (((((bArr[i2] & UByte.MAX_VALUE) | ((bArr[i2 + 1] & UByte.MAX_VALUE) << 8)) | ((bArr[i2 + 2] & UByte.MAX_VALUE) << 16)) | ((bArr[i2 + 3] & UByte.MAX_VALUE) << 24)) >> b[i]) & f8563c[i & 1];
        }
        return jArr;
    }
