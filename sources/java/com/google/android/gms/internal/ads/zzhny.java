...
public final class zzhny extends zziar implements zzicd {
    private static final zzhny zzc;
    ...
    static {
        ...
        zzc = zzhnyVar;
        zziar.x(zzhny.class, zzhnyVar);
    }

    public static zzhny F(zzhzl zzhzlVar, zziab zziabVar) {
        return (zzhny) zziar.r(zzc, zzhzlVar, zziabVar);
    }

    public static zzhnx G() {
        return (zzhnx) zzc.u();
    }
