...
public final class zzauj {
    ...
    public final void b(zzaus zzausVar) {
        ...
        int l = a.l((i2 & (~i)) | i3, (i & i4) | i5, i6, i7);
        int i9 = this.b;
        if (i9 < ((i8 % 937558955) ^ l)) {
            ArrayList arrayList = this.f4422a;
            if (i9 == arrayList.size()) {
                arrayList.add(zzausVar);
            } else {
                arrayList.set(this.b, zzausVar);
            }
            this.b++;
            return;
        }
    ...
    public final zzaus c() {
        ...
        if (i10 > 0) {
            int i11 = i9 ^ l;
            ArrayList arrayList = this.f4422a;
            zzaus zzausVar = (zzaus) arrayList.get(i10 + i11);
    ...
    public final zzaus d(long j) {
        return (zzaus) this.f4422a.get(a(j));
    }
}
