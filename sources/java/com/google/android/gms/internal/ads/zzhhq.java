...
public final class zzhhq {
    ...
    public static final ECParameterSpec f8558a = g("115792089210356248762697446949407573530086143415290314195533631308867097853951", "115792089210356248762697446949407573529996955224135760342422259061068512044369", "5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", "6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296", "4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5");
    ...
    public static final ECParameterSpec f8559c = g("6864797660130609714981900799081393217269435300143305409394463459185543183397656052122559640661454554977296311391480858037121987999716643812574028291115057151", "6864797660130609714981900799081393217269435300143305409394463459185543183397655394245057746333217197532963996371363321113864768612440380340372808892707005449", "051953eb9618e1c9a1f929a21a0b68540eea2da725b99b315f3b8b489918ef109e156193951ec7e937b1652c0bd3bb1bf073573df883d2c34f1ef451fd46b503f00", "c6858e06b70404e9cd9e3ecb662395b4429c648139053fb521f828af606b4d3dbaa14b5e77efe75928fe1dc127a2ffa8de3348b3c1856a429bf97e7e31c2e5bd66", "11839296a789a3bc0045c8a5fb42c7d1bd998f54449579b446817afbd17273e662c97ee72995ef42640c550b9013fad0761353c7086a272c24088be94769fd16650");
    ...
    public static zzhhp d(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return zzhhp.d;
        }
        BigInteger mod = new BigInteger(1, zzhkc.a((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger mod2 = mod.multiply(mod).mod(bigInteger);
        return new zzhhp(eCPoint.getAffineX().multiply(mod2).mod(bigInteger), eCPoint.getAffineY().multiply(mod2.multiply(mod).mod(bigInteger)).mod(bigInteger), mod);
    }

    public static zzhhp e(zzhhp zzhhpVar, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = zzhhpVar.b;
        if (bigInteger3.equals(BigInteger.ZERO)) {
            return zzhhp.d;
        }
        BigInteger bigInteger4 = zzhhpVar.f8556a;
        ...
        BigInteger bigInteger5 = zzhhpVar.f8557c;
        ...
        return new zzhhp(mod5, mod6, add3.multiply(add3).mod(bigInteger2).subtract(mod2).subtract(mod4).mod(bigInteger2));
    }

    public static zzhhp f(zzhhp zzhhpVar, zzhhp zzhhpVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = zzhhpVar.f8557c;
        BigInteger bigInteger4 = BigInteger.ZERO;
        if (bigInteger3.equals(bigInteger4)) {
            return zzhhpVar2;
        }
        if (zzhhpVar2.f8557c.equals(bigInteger4)) {
            return zzhhpVar;
        }
        BigInteger bigInteger5 = zzhhpVar.f8557c;
        BigInteger mod = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger bigInteger6 = zzhhpVar2.f8557c;
        BigInteger mod2 = bigInteger6.multiply(bigInteger6).mod(bigInteger2);
        BigInteger mod3 = zzhhpVar.f8556a.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzhhpVar2.f8556a.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzhhpVar.b.multiply(bigInteger6).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzhhpVar2.b.multiply(bigInteger5).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            if (!mod5.equals(mod6)) {
                return zzhhp.d;
            }
            return e(zzhhpVar, bigInteger, bigInteger2);
        }
        ...
        return new zzhhp(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }
