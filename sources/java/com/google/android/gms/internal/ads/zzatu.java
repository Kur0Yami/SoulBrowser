...
public final class zzatu {
    ...
    public static final int[] f4411a;
    ...
    public static String a(String str) {
        ...
        while (i3 < decode.length) {
                ...
                while (true) {
                    if (i23 != 91464932) {
                        if (i23 != 1326254146) {
                            ...
                            int i24 = i9 >>> i11;
                            int[] iArr = f4411a;
                            i8 += ((i9 << i10) ^ (i24 + i9)) ^ (i12 + iArr[i12 & i13]);
                            i12 += i14;
                            i9 += ((i8 << i10) ^ (i24 + i8)) ^ (i12 + iArr[(i12 >> i15) & i13]);
                            i6++;
                            i23 -= 1234789214;
                        }
                    } else {
                        int i25 = 751433995 + i23;
                        i23 += 1234789214;
                        if (i6 >= i7) {
                            i23 = i25;
                        }
            ...
            decode[i3] = (byte) (((decode[i3] ^ bArr[i4]) << 24) >> 24);
            i3++;
            i2 = i;
        }
