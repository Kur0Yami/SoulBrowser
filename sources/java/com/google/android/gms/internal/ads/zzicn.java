...
public final class zzicn extends zzhyx implements RandomAccess {
    public static final Object[] h;
    public static final zzicn i;
    public Object[] f;
    public int g;
    ...
    static {
        ...
        h = objArr;
        i = new zzicn(objArr, 0, false);
    }

    public zzicn(Object[] objArr, int i2, boolean z) {
        super(z);
        this.f = objArr;
        this.g = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzibd e(int i2) {
        Object[] copyOf;
        if (i2 >= this.g) {
            if (i2 == 0) {
                copyOf = h;
            ...
            return new zzicn(copyOf, this.g, true);
        }
