...
public final class zzhqe extends zziar implements zzicd {
    private static final zzhqe zzj;
    ...
    static {
        zzhqe zzhqeVar = new zzhqe();
        zzj = zzhqeVar;
        zziar.x(zzhqe.class, zzhqeVar);
    }
    ...
    public static zzhqe L(zzhzl zzhzlVar, zziab zziabVar) {
        return (zzhqe) zziar.r(zzj, zzhzlVar, zziabVar);
    }

    public static zzhqd M() {
        return (zzhqd) zzj.u();
    }
    ...
    public final /* synthetic */ void P(zzhqg zzhqgVar) {
        this.zzc = zzhqgVar;
        this.zza |= 1;
    }
