...
final class zzdm implements ObjectEncoder {
    ...
    public static final zzdm f10978a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_common.zzdm, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10920a = 1;
        FieldDescriptor.Builder l = a.l(obj, builder, "durationMs");
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        FieldDescriptor.Builder l2 = a.l(obj2, l, "errorCode");
        ?? obj3 = new Object();
        obj3.f10920a = 3;
        FieldDescriptor.Builder l3 = a.l(obj3, l2, "allowManualInput");
        ?? obj4 = new Object();
        obj4.f10920a = 4;
        a.y(obj4, l3);
    }
