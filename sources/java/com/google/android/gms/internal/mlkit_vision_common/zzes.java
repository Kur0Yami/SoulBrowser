...
final class zzes implements ObjectEncoder {
    ...
    public static final zzes f11013a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_vision_common.zzes] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10920a = 1;
        FieldDescriptor.Builder l = a.l(obj, builder, "isWifiRequired");
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        FieldDescriptor.Builder l2 = a.l(obj2, l, "isDeviceIdleRequired");
        ?? obj3 = new Object();
        obj3.f10920a = 3;
        FieldDescriptor.Builder l3 = a.l(obj3, l2, "canDownloadInBackground");
        ?? obj4 = new Object();
        obj4.f10920a = 4;
        a.y(obj4, l3);
    }
