...
final class zzbz implements ObjectEncoder {
    ...
    public static final zzbz f10939a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_common.zzbz, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10920a = 1;
        FieldDescriptor.Builder l = a.l(obj, builder, "hasResult");
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        FieldDescriptor.Builder l2 = a.l(obj2, l, "isColdCall");
        ?? obj3 = new Object();
        obj3.f10920a = 3;
        FieldDescriptor.Builder l3 = a.l(obj3, l2, "imageInfo");
        ?? obj4 = new Object();
        obj4.f10920a = 4;
        FieldDescriptor.Builder l4 = a.l(obj4, l3, "options");
        ?? obj5 = new Object();
        obj5.f10920a = 5;
        FieldDescriptor.Builder l5 = a.l(obj5, l4, "detectedBarcodeFormats");
        ?? obj6 = new Object();
        obj6.f10920a = 6;
        FieldDescriptor.Builder l6 = a.l(obj6, l5, "detectedBarcodeValueTypes");
        ?? obj7 = new Object();
        obj7.f10920a = 7;
        a.y(obj7, l6);
    }
