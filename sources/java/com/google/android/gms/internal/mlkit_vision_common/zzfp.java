...
final class zzfp implements ObjectEncoder {
    ...
    public static final zzfp f11036a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_common.zzfp, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10920a = 1;
        FieldDescriptor.Builder l = a.l(obj, builder, "confidenceThreshold");
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        FieldDescriptor.Builder l2 = a.l(obj2, l, "customLocalModelOptions");
        ?? obj3 = new Object();
        obj3.f10920a = 3;
        a.y(obj3, l2);
    }
