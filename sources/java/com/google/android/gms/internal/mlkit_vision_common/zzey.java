...
final class zzey implements ObjectEncoder {
    ...
    public static final zzey f11019a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_common.zzey, java.lang.Object] */
    ...
    static {
        ...
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        FieldDescriptor.Builder l2 = a.l(obj2, l, "detectedBarcodeFormats");
        ?? obj3 = new Object();
        obj3.f10920a = 3;
        FieldDescriptor.Builder l3 = a.l(obj3, l2, "detectedBarcodeValueTypes");
        ?? obj4 = new Object();
        obj4.f10920a = 4;
