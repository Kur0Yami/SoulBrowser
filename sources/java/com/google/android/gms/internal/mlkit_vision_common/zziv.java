...
public enum zziv implements zzag {
    ...
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(HttpStatusCodes.STATUS_CODE_OK),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(HttpStatusCodes.STATUS_CODE_CREATED),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(HttpStatusCodes.STATUS_CODE_ACCEPTED),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(203),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(HttpStatusCodes.STATUS_CODE_NO_CONTENT),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(HttpStatusCodes.STATUS_CODE_MOVED_PERMANENTLY),
    /* JADX INFO: Fake field, exist only in values array */
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(HttpStatusCodes.STATUS_CODE_FOUND),
    ...
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_LANGUAGE_ID(HttpStatusCodes.STATUS_CODE_UNAUTHORIZED),
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_LANGUAGE_ID_CREATE(402),
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_LANGUAGE_ID_INIT(HttpStatusCodes.STATUS_CODE_FORBIDDEN),
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_LANGUAGE_ID_INFERENCE(HttpStatusCodes.STATUS_CODE_NOT_FOUND),
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_LANGUAGE_ID_RELEASE(HttpStatusCodes.STATUS_CODE_METHOD_NOT_ALLOWED),
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_NLCLASSIFIER(411),
    /* JADX INFO: Fake field, exist only in values array */
    OPTIONAL_MODULE_NLCLASSIFIER_CREATE(HttpStatusCodes.STATUS_CODE_PRECONDITION_FAILED),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    NLCLASSIFIER_CLIENT_LIBRARY_CREATE(HttpStatusCodes.STATUS_CODE_UNPROCESSABLE_ENTITY),
    /* JADX INFO: Fake field, exist only in values array */
    ...
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_EXPLICIT_CONTENT_LOAD(HttpStatusCodes.STATUS_CODE_BAD_GATEWAY),
    /* JADX INFO: Fake field, exist only in values array */
    ON_DEVICE_EXPLICIT_CONTENT_DETECT(HttpStatusCodes.STATUS_CODE_SERVICE_UNAVAILABLE),
    /* JADX INFO: Fake field, exist only in values array */
