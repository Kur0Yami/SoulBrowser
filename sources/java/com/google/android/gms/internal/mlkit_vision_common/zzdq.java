...
final class zzdq implements ObjectEncoder {
    ...
    public static final zzdq f10982a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_vision_common.zzdq] */
    ...
    static {
        ...
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        FieldDescriptor.Builder l2 = a.l(obj2, l, "inputsFormats");
        ?? obj3 = new Object();
        obj3.f10920a = 3;
        FieldDescriptor.Builder l3 = a.l(obj3, l2, "outputFormats");
        ?? obj4 = new Object();
        obj4.f10920a = 4;
        FieldDescriptor.Builder l4 = a.l(obj4, l3, "modelInitializationMs");
        ?? obj5 = new Object();
        obj5.f10920a = 5;
        a.y(obj5, l4);
    }
