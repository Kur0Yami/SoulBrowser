...
final class zzdp implements ObjectEncoder {
    ...
    public static final zzdp f10981a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_vision_common.zzdp] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10920a = 1;
        FieldDescriptor.Builder l = a.l(obj, builder, "dims");
        ?? obj2 = new Object();
        obj2.f10920a = 2;
        a.y(obj2, l);
    }
