...
final class zzfe extends zzeh implements RandomAccess, zzga {
    ...
    public zzfe(double[] dArr, int i, boolean z) {
        super(z);
        this.f = dArr;
        this.g = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzfeVar.f, 0, this.f, this.g, zzfeVar.g);
            this.g = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final /* bridge */ /* synthetic */ zzga f(int i) {
        ...
        if (i >= this.g) {
            ...
            return new zzfe(copyOf, this.g, true);
        }
