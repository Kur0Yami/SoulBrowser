...
public class zzid extends com.google.android.gms.drive.metadata.internal.zzm<AppVisibleCustomProperties> {
    ...
    public static final com.google.android.gms.drive.metadata.internal.zzg f10194c = new Object();
    ...
    public final Object f(DataHolder dataHolder, int i, int i2) {
        ...
        if (sparseParcelableArray == null) {
                    ...
                    if (dataHolder2 != null) {
                        try {
                            ...
                            for (int i3 = 0; i3 < dataHolder2.getCount(); i3++) {
                                ...
                                AppVisibleCustomProperties.zza zzaVar = (AppVisibleCustomProperties.zza) longSparseArray.d(j);
                                if (zzaVar == null) {
                                    zzaVar = new AppVisibleCustomProperties.zza();
                                    longSparseArray.g(j, zzaVar);
                                }
                                Preconditions.checkNotNull(zzcVar, "property");
                                zzaVar.f3700a.put(zzcVar.f3703c, zzcVar);
                            }
                            SparseArray<? extends Parcelable> sparseArray = new SparseArray<>();
                            for (int i4 = 0; i4 < dataHolder.getCount(); i4++) {
                                AppVisibleCustomProperties.zza zzaVar2 = (AppVisibleCustomProperties.zza) longSparseArray.d(dataHolder.getLong("sqlId", i4, dataHolder.getWindowIndex(i4)));
                                if (zzaVar2 != null) {
                                    sparseArray.append(i4, new AppVisibleCustomProperties(zzaVar2.f3700a.values()));
                                }
                            }
            ...
            if (sparseParcelableArray == null) {
                return AppVisibleCustomProperties.f;
            }
        }
        return (AppVisibleCustomProperties) sparseParcelableArray.get(i, AppVisibleCustomProperties.f);
    }
}
