...
public final class zzhh implements ObjectEncoder {
    ...
    public static final zzhh f11229a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_text_common.zzhh, java.lang.Object] */
    ...
    static {
        ...
        ?? obj2 = new Object();
        obj2.f11145a = 2;
        FieldDescriptor.Builder n2 = a.n(obj2, n, "inputsFormats");
        ?? obj3 = new Object();
        obj3.f11145a = 3;
        FieldDescriptor.Builder n3 = a.n(obj3, n2, "outputFormats");
        ?? obj4 = new Object();
        obj4.f11145a = 4;
        FieldDescriptor.Builder n4 = a.n(obj4, n3, "modelInitializationMs");
        ?? obj5 = new Object();
        obj5.f11145a = 5;
        a.y(obj5, n4);
    }
