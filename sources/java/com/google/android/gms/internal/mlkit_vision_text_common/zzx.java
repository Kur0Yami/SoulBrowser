...
public final class zzx {
    public static void a(int i, int i2) {
        ...
        if (i >= 0) {
            ...
            a2 = zzy.a("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i2));
        } else {
            a2 = zzy.a("%s (%s) must not be negative", "index", Integer.valueOf(i));
        }
    ...
    public static void b(int i, int i2, int i3) {
        ...
        if (i >= 0 && i <= i3) {
            if (i2 >= 0 && i2 <= i3) {
                c2 = zzy.a("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            } else {
