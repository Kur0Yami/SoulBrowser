...
public final class zzix implements ObjectEncoder {
    ...
    public static final zzix f11275a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_text_common.zzix, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f11145a = 1;
        FieldDescriptor.Builder n = a.n(obj, builder, "classificationConfidence");
        ?? obj2 = new Object();
        obj2.f11145a = 2;
        FieldDescriptor.Builder n2 = a.n(obj2, n, "trackingId");
        ?? obj3 = new Object();
        obj3.f11145a = 3;
        FieldDescriptor.Builder n3 = a.n(obj3, n2, "labelCount");
        ?? obj4 = new Object();
        obj4.f11145a = 4;
        a.y(obj4, n3);
    }
