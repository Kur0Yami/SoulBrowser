...
public final class zzii implements ObjectEncoder {
    ...
    public static final zzii f11259a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_vision_text_common.zzii, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f11145a = 1;
        FieldDescriptor.Builder n = a.n(obj, builder, "identifyAllLanguagesConfidenceThreshold");
        ?? obj2 = new Object();
        obj2.f11145a = 2;
        FieldDescriptor.Builder n2 = a.n(obj2, n, "confidenceThreshold");
        ?? obj3 = new Object();
        obj3.f11145a = 3;
        a.y(obj3, n2);
    }
