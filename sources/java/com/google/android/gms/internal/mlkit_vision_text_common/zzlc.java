...
public final class zzlc implements ObjectEncoder {
    ...
    public static final zzlc f11334a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_vision_text_common.zzlc] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f11145a = 1;
        FieldDescriptor.Builder n = a.n(obj, builder, "streamModeSmoothingRatio");
        ?? obj2 = new Object();
        obj2.f11145a = 2;
        FieldDescriptor.Builder n2 = a.n(obj2, n, "rawSizeMaskEnabled");
        ?? obj3 = new Object();
        obj3.f11145a = 3;
        a.y(obj3, n2);
    }
