...
public final class zzry extends zzpb implements RandomAccess {
    public static final Object[] h;
    public static final zzry i;
    public Object[] f;
    public int g;
    ...
    static {
        ...
        h = objArr;
        i = new zzry(objArr, 0, false);
    }

    public zzry(Object[] objArr, int i2, boolean z) {
        super(z);
        this.f = objArr;
        this.g = i2;
    }
    ...
    public final /* bridge */ /* synthetic */ zzqr f(int i2) {
        Object[] copyOf;
        if (i2 >= this.g) {
            if (i2 == 0) {
                copyOf = h;
            ...
            return new zzry(copyOf, this.g, true);
        }
