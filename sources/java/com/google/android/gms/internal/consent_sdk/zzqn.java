...
final class zzqn extends zzpb implements RandomAccess, zzqq {
    ...
    static {
        int[] iArr = new int[0];
        h = iArr;
        i = new zzqn(iArr, 0, false);
    }

    public zzqn(int[] iArr, int i2, boolean z) {
        super(z);
        this.f = iArr;
        this.g = i2;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(zzqnVar.f, 0, this.f, this.g, zzqnVar.g);
            this.g = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final /* bridge */ /* synthetic */ zzqr f(int i2) {
        ...
        if (i2 >= this.g) {
            ...
            return new zzqn(copyOf, this.g, true);
        }
