...
final class zzhk implements ObjectEncoder {
    ...
    public static final zzhk f10575a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzhk, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10416a = 3;
        FieldDescriptor.Builder j = a.j(obj, builder, "isUsingLegacyApi");
        ?? obj2 = new Object();
        obj2.f10416a = 4;
        FieldDescriptor.Builder j2 = a.j(obj2, j, "sdkVersion");
        ?? obj3 = new Object();
        obj3.f10416a = 5;
        a.w(obj3, j2);
    }
