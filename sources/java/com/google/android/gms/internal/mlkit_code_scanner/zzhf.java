...
final class zzhf implements ObjectEncoder {
    ...
    public static final zzhf f10570a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzhf, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10416a = 1;
        FieldDescriptor.Builder j = a.j(obj, builder, "streamModeSmoothingRatio");
        ?? obj2 = new Object();
        obj2.f10416a = 2;
        FieldDescriptor.Builder j2 = a.j(obj2, j, "rawSizeMaskEnabled");
        ?? obj3 = new Object();
        obj3.f10416a = 3;
        a.w(obj3, j2);
    }
