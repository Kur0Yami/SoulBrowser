...
final class zzep implements ObjectEncoder {
    ...
    public static final zzep f10500a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzep, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10416a = 1;
        FieldDescriptor.Builder j = a.j(obj, builder, "originalImageSize");
        ?? obj2 = new Object();
        obj2.f10416a = 2;
        FieldDescriptor.Builder j2 = a.j(obj2, j, "compressedImageSize");
        ?? obj3 = new Object();
        obj3.f10416a = 3;
        FieldDescriptor.Builder j3 = a.j(obj3, j2, "isOdmlImage");
        ?? obj4 = new Object();
        obj4.f10416a = 4;
        a.w(obj4, j3);
    }
