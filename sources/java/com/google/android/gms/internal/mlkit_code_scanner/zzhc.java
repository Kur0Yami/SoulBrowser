...
final class zzhc implements ObjectEncoder {
    ...
    public static final zzhc f10567a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzhc, java.lang.Object] */
    ...
    static {
        ...
        ?? obj3 = new Object();
        obj3.f10416a = 3;
        FieldDescriptor.Builder j3 = a.j(obj3, j2, "loadDurationMs");
        ?? obj4 = new Object();
        obj4.f10416a = 4;
        FieldDescriptor.Builder j4 = a.j(obj4, j3, "sessionDurationMs");
        ?? obj5 = new Object();
        obj5.f10416a = 5;
        FieldDescriptor.Builder j5 = a.j(obj5, j4, "sessionTotalInferenceDurationMs");
        ?? obj6 = new Object();
        obj6.f10416a = 6;
        a.w(obj6, j5);
    }
