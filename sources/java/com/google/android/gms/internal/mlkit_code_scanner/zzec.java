...
final class zzec implements ObjectEncoder {
    ...
    public static final zzec f10487a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzec, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10416a = 1;
        FieldDescriptor.Builder j = a.j(obj, builder, "localModelOptions");
        ?? obj2 = new Object();
        obj2.f10416a = 2;
        FieldDescriptor.Builder j2 = a.j(obj2, j, "errorCodes");
        ?? obj3 = new Object();
        obj3.f10416a = 3;
        FieldDescriptor.Builder j3 = a.j(obj3, j2, "modelInitializationMs");
        ?? obj4 = new Object();
        obj4.f10416a = 4;
        FieldDescriptor.Builder j4 = a.j(obj4, j3, "isNnApiEnabled");
        ?? obj5 = new Object();
        obj5.f10416a = 5;
        a.w(obj5, j4);
    }
