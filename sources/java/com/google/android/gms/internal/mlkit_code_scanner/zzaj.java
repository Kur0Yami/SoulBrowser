...
public final class zzaj implements ObjectEncoderContext {
    ...
    public OutputStream f10420a;
    public final HashMap b;

    /* renamed from: c, reason: collision with root package name */
    public final HashMap f10421c;
    public final ObjectEncoder d;
    public final zzan e = new zzan(this);
    ...
    public zzaj(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ObjectEncoder objectEncoder) {
        this.f10420a = byteArrayOutputStream;
        this.b = hashMap;
        this.f10421c = hashMap2;
        this.d = objectEncoder;
    }

    public static int f(FieldDescriptor fieldDescriptor) {
        zzah zzahVar = (zzah) fieldDescriptor.b(zzah.class);
        if (zzahVar != null) {
            return zzahVar.zza();
        }
        ...
        if (obj != null) {
            ...
            if (obj instanceof Double) {
                ...
                if (!z || doubleValue != 0.0d) {
                    ...
                    this.f10420a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(doubleValue).array());
                    return;
                }
                return;
            }
            if (obj instanceof Float) {
                ...
                if (!z || floatValue != 0.0f) {
                    ...
                    this.f10420a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                    return;
                }
                return;
            }
            ...
            ValueEncoder valueEncoder = (ValueEncoder) this.f10421c.get(obj.getClass());
            if (valueEncoder != null) {
                zzan zzanVar = this.e;
                zzanVar.f10427a = false;
                zzanVar.f10428c = fieldDescriptor;
                zzanVar.b = z;
                valueEncoder.a(obj, zzanVar);
                return;
            }
            if (obj instanceof zzaf) {
                c(fieldDescriptor, ((zzaf) obj).zza(), true);
    ...
    public final void c(FieldDescriptor fieldDescriptor, int i2, boolean z) {
        if (!z || i2 != 0) {
            zzah zzahVar = (zzah) fieldDescriptor.b(zzah.class);
            if (zzahVar != null) {
                int ordinal = zzahVar.zzb().ordinal();
                if (ordinal != 0) {
                    if (ordinal != 1) {
                        if (ordinal != 2) {
                            return;
                        ...
                        h((zzahVar.zza() << 3) | 5);
                        this.f10420a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putInt(i2).array());
                        return;
                    }
                    h(zzahVar.zza() << 3);
                    h((i2 + i2) ^ (i2 >> 31));
            ...
            if (zzahVar != null) {
                ...
                if (ordinal != 0) {
                    if (ordinal != 1) {
                        ...
                        h((zzahVar.zza() << 3) | 1);
                        this.f10420a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putLong(j).array());
                        return;
                    }
                    h(zzahVar.zza() << 3);
                    i((j >> 63) ^ (j + j));
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [java.io.OutputStream, com.google.android.gms.internal.mlkit_code_scanner.zzae] */
    public final void g(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
        ?? outputStream = new OutputStream();
        outputStream.f10417c = 0L;
        try {
            OutputStream outputStream2 = this.f10420a;
            this.f10420a = outputStream;
            try {
                objectEncoder.a(obj, this);
                this.f10420a = outputStream2;
                long j = outputStream.f10417c;
                outputStream.close();
                if (z && j == 0) {
                    return;
                }
    ...
    public final void h(int i2) {
        while ((i2 & (-128)) != 0) {
            this.f10420a.write((i2 & 127) | Uuid.SIZE_BITS);
            i2 >>>= 7;
        }
        this.f10420a.write(i2 & 127);
    }

    public final void i(long j) {
        while (((-128) & j) != 0) {
            this.f10420a.write((((int) j) & 127) | Uuid.SIZE_BITS);
            j >>>= 7;
        }
        this.f10420a.write(((int) j) & 127);
    }
}
