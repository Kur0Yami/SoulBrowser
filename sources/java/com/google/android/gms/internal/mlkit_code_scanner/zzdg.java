...
final class zzdg implements ObjectEncoder {
    ...
    public static final zzdg f10463a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzdg, java.lang.Object] */
    ...
    static {
        ...
        ?? obj2 = new Object();
        obj2.f10416a = 2;
        FieldDescriptor.Builder j2 = a.j(obj2, j, "modelInitializationMs");
        ?? obj3 = new Object();
        obj3.f10416a = 3;
        FieldDescriptor.Builder j3 = a.j(obj3, j2, "confidenceThreshold");
        ?? obj4 = new Object();
        obj4.f10416a = 4;
