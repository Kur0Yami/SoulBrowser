...
final class zzdm implements ObjectEncoder {
    ...
    public static final zzdm f10469a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_code_scanner.zzdm, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10416a = 1;
        FieldDescriptor.Builder j = a.j(obj, builder, "modelType");
        ?? obj2 = new Object();
        obj2.f10416a = 2;
        a.w(obj2, j);
    }
