...
final class zzja implements ObjectEncoder {
    ...
    public static final zzja f10835a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_common.zzja] */
    ...
    static {
        ...
        ?? obj3 = new Object();
        obj3.f10659a = 3;
        FieldDescriptor.Builder k3 = a.k(obj3, k2, "loadDurationMs");
        ?? obj4 = new Object();
        obj4.f10659a = 4;
        FieldDescriptor.Builder k4 = a.k(obj4, k3, "sessionDurationMs");
        ?? obj5 = new Object();
        obj5.f10659a = 5;
        FieldDescriptor.Builder k5 = a.k(obj5, k4, "sessionTotalInferenceDurationMs");
        ?? obj6 = new Object();
        obj6.f10659a = 6;
        a.x(obj6, k5);
    }
