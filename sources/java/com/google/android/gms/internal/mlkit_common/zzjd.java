...
final class zzjd implements ObjectEncoder {
    ...
    public static final zzjd f10838a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_common.zzjd] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "streamModeSmoothingRatio");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "rawSizeMaskEnabled");
        ?? obj3 = new Object();
        obj3.f10659a = 3;
        a.x(obj3, k2);
    }
