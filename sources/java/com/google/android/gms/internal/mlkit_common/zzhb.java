...
final class zzhb implements ObjectEncoder {
    ...
    public static final zzhb f10783a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_common.zzhb] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "actualCount");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        a.x(obj2, k);
    }
