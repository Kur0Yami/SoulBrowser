...
final class zzjp implements ObjectEncoder {
    ...
    public static final zzjp f10850a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_common.zzjp] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 3;
        FieldDescriptor.Builder k = a.k(obj, builder, "isUsingLegacyApi");
        ?? obj2 = new Object();
        obj2.f10659a = 4;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "sdkVersion");
        ?? obj3 = new Object();
        obj3.f10659a = 5;
        a.x(obj3, k2);
    }
