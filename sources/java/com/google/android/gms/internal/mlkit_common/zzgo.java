...
final class zzgo implements ObjectEncoder {
    ...
    public static final zzgo f10766a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_common.zzgo, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "logSceneBrightness");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        a.x(obj2, k);
    }
