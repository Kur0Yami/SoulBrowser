...
final class zzen implements ObjectEncoder {
    ...
    public static final zzen f10710a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_common.zzen, java.lang.Object] */
    ...
    static {
        ...
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "modelInitializationMs");
        ?? obj3 = new Object();
        obj3.f10659a = 3;
        FieldDescriptor.Builder k3 = a.k(obj3, k2, "confidenceThreshold");
        ?? obj4 = new Object();
        obj4.f10659a = 4;
