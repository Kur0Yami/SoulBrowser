...
final class zzin implements ObjectEncoder {
    ...
    public static final zzin f10822a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_common.zzin, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "confidenceThreshold");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "customLocalModelOptions");
        ?? obj3 = new Object();
        obj3.f10659a = 3;
        a.x(obj3, k2);
    }
