...
final class zzgn implements ObjectEncoder {
    ...
    public static final zzgn f10765a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_common.zzgn] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "physicalCameraIds");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "deviceModel");
        ?? obj3 = new Object();
        obj3.f10659a = 3;
        FieldDescriptor.Builder k3 = a.k(obj3, k2, "enableMlDenoiser");
        ?? obj4 = new Object();
        obj4.f10659a = 4;
        a.x(obj4, k3);
    }
