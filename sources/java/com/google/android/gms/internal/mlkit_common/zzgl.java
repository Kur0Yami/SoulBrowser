...
final class zzgl implements ObjectEncoder {
    ...
    public static final zzgl f10763a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_common.zzgl, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "latencyMs");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "burstCount");
        ?? obj3 = new Object();
        obj3.f10659a = 3;
        FieldDescriptor.Builder k3 = a.k(obj3, k2, "estimatedCaptureLatencyMs");
        ?? obj4 = new Object();
        obj4.f10659a = 4;
        FieldDescriptor.Builder k4 = a.k(obj4, k3, "errorCode");
        ?? obj5 = new Object();
        obj5.f10659a = 5;
        a.x(obj5, k4);
    }
