...
final class zzii implements ObjectEncoder {
    ...
    public static final zzii f10817a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_common.zzii, java.lang.Object] */
    ...
    static {
        ...
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        FieldDescriptor.Builder k2 = a.k(obj2, k, "captionCount");
        ?? obj3 = new Object();
        obj3.f10659a = 4;
        FieldDescriptor.Builder k3 = a.k(obj3, k2, "highestScore");
        ?? obj4 = new Object();
        obj4.f10659a = 5;
        FieldDescriptor.Builder k4 = a.k(obj4, k3, "imageType");
        ?? obj5 = new Object();
        obj5.f10659a = 6;
        a.x(obj5, k4);
    }
