...
final class zzdp implements ObjectEncoder {
    ...
    public static final zzdp f10686a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, com.google.android.gms.internal.mlkit_common.zzdp] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "isColdCall");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        ...
        ?? obj4 = new Object();
        obj4.f10659a = 4;
        FieldDescriptor.Builder k4 = a.k(obj4, k3, "contourDetectedFaces");
        ?? obj5 = new Object();
        obj5.f10659a = 5;
        FieldDescriptor.Builder k5 = a.k(obj5, k4, "nonContourDetectedFaces");
        ?? obj6 = new Object();
        obj6.f10659a = 6;
        a.x(obj6, k5);
    }
