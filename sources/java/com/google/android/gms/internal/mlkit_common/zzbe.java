...
public final class zzbe implements ObjectEncoderContext {
    ...
    public OutputStream f10662a;
    public final HashMap b;

    /* renamed from: c, reason: collision with root package name */
    public final HashMap f10663c;
    ...
    public zzbe(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ObjectEncoder objectEncoder) {
        this.f10662a = byteArrayOutputStream;
        this.b = hashMap;
        this.f10663c = hashMap2;
        ...
        if (obj != null) {
            ...
            if (obj instanceof Double) {
                ...
                if (!z || doubleValue != 0.0d) {
                    ...
                    this.f10662a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(doubleValue).array());
                    return;
                }
                return;
            }
            if (obj instanceof Float) {
                ...
                if (!z || floatValue != 0.0f) {
                    ...
                    this.f10662a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                    return;
                }
                return;
            }
            ...
            ValueEncoder valueEncoder = (ValueEncoder) this.f10663c.get(obj.getClass());
            if (valueEncoder != null) {
                zzbi zzbiVar = this.e;
                zzbiVar.f10668a = false;
                zzbiVar.f10669c = fieldDescriptor;
                zzbiVar.b = z;
    ...
    public final void c(FieldDescriptor fieldDescriptor, int i2, boolean z) {
        if (!z || i2 != 0) {
            zzbc zzbcVar = (zzbc) fieldDescriptor.b(zzbc.class);
            if (zzbcVar != null) {
                int ordinal = zzbcVar.zzb().ordinal();
                if (ordinal != 0) {
                    if (ordinal != 1) {
                        if (ordinal != 2) {
                            return;
                        ...
                        h((zzbcVar.zza() << 3) | 5);
                        this.f10662a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putInt(i2).array());
                        return;
                    }
                    h(zzbcVar.zza() << 3);
                    h((i2 + i2) ^ (i2 >> 31));
            ...
            if (zzbcVar != null) {
                ...
                if (ordinal != 0) {
                    if (ordinal != 1) {
                        ...
                        h((zzbcVar.zza() << 3) | 1);
                        this.f10662a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putLong(j).array());
                        return;
                    }
                    h(zzbcVar.zza() << 3);
                    i((j >> 63) ^ (j + j));
    ...
    public final void g(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
        ...
        outputStream.f10660c = 0L;
        try {
            OutputStream outputStream2 = this.f10662a;
            this.f10662a = outputStream;
            try {
                objectEncoder.a(obj, this);
                this.f10662a = outputStream2;
                long j = outputStream.f10660c;
                outputStream.close();
                if (z && j == 0) {
                    return;
                }
    ...
    public final void h(int i2) {
        while (true) {
            int i3 = i2 & 127;
            if ((i2 & (-128)) != 0) {
                this.f10662a.write(i3 | Uuid.SIZE_BITS);
                i2 >>>= 7;
            } else {
                this.f10662a.write(i3);
                return;
            }
        }
    }
    ...
    public final void i(long j) {
        while (true) {
            int i2 = ((int) j) & 127;
            if (((-128) & j) != 0) {
                this.f10662a.write(i2 | Uuid.SIZE_BITS);
                j >>>= 7;
            } else {
                this.f10662a.write(i2);
                return;
            }
        }
    }
