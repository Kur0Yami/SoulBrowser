...
final class zzet implements ObjectEncoder {
    ...
    public static final zzet f10716a = new Object();

    /* JADX WARN: Type inference failed for: r0v0, types: [com.google.android.gms.internal.mlkit_common.zzet, java.lang.Object] */
    ...
    static {
        ...
        ?? obj = new Object();
        obj.f10659a = 1;
        FieldDescriptor.Builder k = a.k(obj, builder, "modelType");
        ?? obj2 = new Object();
        obj2.f10659a = 2;
        a.x(obj2, k);
    }
