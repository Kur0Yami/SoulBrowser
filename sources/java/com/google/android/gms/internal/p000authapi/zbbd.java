        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                try {
                    ...
                    String q = a.q(new StringBuilder(name.length() + 1 + String.valueOf(hexString).length()), name, "@", hexString);
                    ...
                    StringBuilder sb2 = new StringBuilder(androidx.work.impl.workers.a.d(q.length() + 8, 1, name2));
                    sb2.append("<");
                    sb2.append(q);
                    sb2.append(" threw ");
                    sb2.append(name2);
