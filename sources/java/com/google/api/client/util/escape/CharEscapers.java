...
public final class CharEscapers {
    ...
    static {
        PercentEscaper percentEscaper = new PercentEscaper(PercentEscaper.SAFE_PLUS_RESERVED_CHARS_URLENCODER);
        URI_RESERVED_ESCAPER = percentEscaper;
        URI_USERINFO_ESCAPER = new PercentEscaper(PercentEscaper.SAFEUSERINFOCHARS_URLENCODER);
        URI_QUERY_STRING_ESCAPER = new PercentEscaper(PercentEscaper.SAFEQUERYSTRINGCHARS_URLENCODER);
        URI_RESERVED_AND_PERCENT_ENCODED_ESCAPER = new PercentEncodedEscaper(percentEscaper);
    }
    ...
    public static String escapeUriPathWithoutReservedAndPercentEncoded(String str) {
        return URI_RESERVED_AND_PERCENT_ENCODED_ESCAPER.escape(str);
    }
