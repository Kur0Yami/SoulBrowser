...
public final class NetHttpTransport extends HttpTransport {
    ...
    public static final class Builder {
        ...
        public NetHttpTransport build() {
            ...
            if (this.proxy == null) {
                return new NetHttpTransport(this.connectionFactory, this.sslSocketFactory, this.hostnameVerifier, this.isMtls);
            }
            return new NetHttpTransport(this.proxy, this.sslSocketFactory, this.hostnameVerifier, this.isMtls);
        }
        ...
        @Beta
        public Builder trustCertificates(KeyStore keyStore, KeyStore keyStore2, String str) {
