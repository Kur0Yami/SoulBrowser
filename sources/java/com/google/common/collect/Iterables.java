...
public final class Iterables {
    ...
    public class AnonymousClass4 extends FluentIterable<Object> {
        ...
        @Override // java.lang.Iterable
        public final Iterator iterator() {
            return Iterators.d(this.f.iterator(), this.g);
        }
    }
    ...
    public static boolean a(Iterable iterable, Predicate predicate) {
        ...
        Preconditions.h(predicate, "predicate");
        int i = 0;
        while (true) {
            if (it.hasNext()) {
    ...
    public static Object d(Iterable iterable, Predicate predicate) {
        predicate.getClass();
        Iterator it = iterable.iterator();
        while (it.hasNext()) {
            Object next = it.next();
    ...
    public static void e(List list, Predicate predicate, int i, int i2) {
    ...
    public static Iterable f(final Collection collection, final Function function) {
        collection.getClass();
        return new FluentIterable<Object>() { // from class: com.google.common.collect.Iterables.5
            @Override // java.lang.Iterable
            public final Iterator iterator() {
                return Iterators.k(collection.iterator(), function);
            }
        };
    }
}
