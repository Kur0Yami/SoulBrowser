...
SRC="${ROOT_DIR}/sources/java/com/mycompany/app/web/TabLongPressGate.java"
...
echo "Compiling TabLongPressGate.java..."
...
cp -a "${STAGE}/smali/com/mycompany/app/web/TabLongPressGate"* "${OUT_SMALI}/"
