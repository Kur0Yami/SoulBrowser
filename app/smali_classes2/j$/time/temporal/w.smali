...
.method public final b(Lj$/time/temporal/n;)I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I
...
.method public final c(Lj$/time/temporal/n;)I
    ...
    .line 825
    invoke-virtual {p0, v3, v0}, Lj$/time/temporal/w;->m(II)I
    ...
    .line 833
    :cond_0
    invoke-interface {p1, v2}, Lj$/time/temporal/n;->i(Lj$/time/temporal/r;)Lj$/time/temporal/v;
...
.method public final e(Lj$/time/temporal/n;)I
    .locals 4
    ...
    .line 855
    invoke-virtual {p0, v2, v0}, Lj$/time/temporal/w;->m(II)I
    ...
    invoke-interface {v0, p1}, Lj$/time/chrono/m;->w(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    invoke-interface {p1, v0, v1, v2}, Lj$/time/chrono/b;->o(JLj$/time/temporal/t;)Lj$/time/chrono/b;

    move-result-object p1

    .line 862
    invoke-virtual {p0, p1}, Lj$/time/temporal/w;->e(Lj$/time/temporal/n;)I
    ...
    .line 866
    invoke-interface {p1, v1}, Lj$/time/temporal/n;->i(Lj$/time/temporal/r;)Lj$/time/temporal/v;
...
.method public final f(Lj$/time/chrono/m;III)Lj$/time/chrono/b;
    .locals 3

    const/4 v0, 0x1

    .line 741
    invoke-interface {p1, p2, v0, v0}, Lj$/time/chrono/m;->D(III)Lj$/time/chrono/b;
    ...
    .line 743
    invoke-virtual {p0, v0, p2}, Lj$/time/temporal/w;->m(II)I

    move-result p2

    .line 746
    invoke-interface {p1}, Lj$/time/chrono/b;->H()I
    ...
    invoke-interface {p1, p2, p3, p4}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
...
.method public final g(Lj$/time/temporal/n;)Lj$/time/temporal/v;
    ...
    invoke-virtual {p0, p1, v0}, Lj$/time/temporal/w;->j(Lj$/time/temporal/n;Lj$/time/temporal/a;)Lj$/time/temporal/v;
    ...
    .line 1113
    invoke-virtual {p0, p1}, Lj$/time/temporal/w;->k(Lj$/time/temporal/n;)Lj$/time/temporal/v;
...
.method public final h(Ljava/util/Map;Lj$/time/format/d0;Lj$/time/format/e0;)Lj$/time/temporal/n;
    ...
    .line 933
    invoke-static {v3, v4}, Lj$/com/android/tools/r8/a;->H(J)I
    ...
    .line 954
    invoke-static/range {p2 .. p2}, Lj$/com/android/tools/r8/a;->G(Lj$/time/temporal/n;)Lj$/time/chrono/m;
    ...
    .line 976
    invoke-interface {v12, v6, v10, v10}, Lj$/time/chrono/m;->D(III)Lj$/time/chrono/b;

    move-result-object v2

    const-wide/16 v5, 0x1

    invoke-static {v14, v15, v5, v6}, Lj$/com/android/tools/r8/a;->P(JJ)J

    move-result-wide v5

    invoke-interface {v2, v5, v6, v7}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
    ...
    invoke-interface {v2, v6}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I

    move-result v6

    .line 804
    invoke-virtual {v0, v6, v5}, Lj$/time/temporal/w;->m(II)I
    ...
    .line 977
    invoke-static {v8, v9, v5, v6}, Lj$/com/android/tools/r8/a;->P(JJ)J
    ...
    invoke-interface {v2, v4, v5, v6}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
    ...
    .line 982
    invoke-interface {v12, v6, v7, v10}, Lj$/time/chrono/m;->D(III)Lj$/time/chrono/b;
    ...
    invoke-interface {v6, v10}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I

    move-result v10

    .line 804
    invoke-virtual {v0, v10, v9}, Lj$/time/temporal/w;->m(II)I
    ...
    invoke-interface {v6, v7, v8, v4}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
    ...
    invoke-interface {v4, v5}, Lj$/time/temporal/n;->y(Lj$/time/temporal/r;)J
    ...
    invoke-interface {v5, v6}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I

    move-result v6

    .line 811
    invoke-virtual {v0, v6, v2}, Lj$/time/temporal/w;->m(II)I
    ...
    .line 1002
    invoke-static {v8, v9, v6, v7}, Lj$/com/android/tools/r8/a;->P(JJ)J
    ...
    invoke-interface {v5, v6, v7, v2}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
    ...
    invoke-interface {v5, v10}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I
    ...
    invoke-interface {v5, v7, v8, v4}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
    ...
    invoke-interface {v4, v13}, Lj$/time/temporal/n;->y(Lj$/time/temporal/r;)J
    ...
    .line 1026
    invoke-virtual {v0, v12, v5, v10, v4}, Lj$/time/temporal/w;->f(Lj$/time/chrono/m;III)Lj$/time/chrono/b;
    ...
    .line 1033
    invoke-virtual {v0, v12, v5, v6, v4}, Lj$/time/temporal/w;->f(Lj$/time/chrono/m;III)Lj$/time/chrono/b;
...
.method public final i(Lj$/time/temporal/n;)J
    ...
    .line 804
    invoke-virtual {p0, p1, v0}, Lj$/time/temporal/w;->m(II)I
...
.method public final j(Lj$/time/temporal/n;Lj$/time/temporal/a;)Lj$/time/temporal/v;
    .locals 3
    ...
    .line 1129
    invoke-interface {p1, p2}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I

    move-result v1

    invoke-virtual {p0, v1, v0}, Lj$/time/temporal/w;->m(II)I

    move-result v0

    .line 1130
    invoke-interface {p1, p2}, Lj$/time/temporal/n;->i(Lj$/time/temporal/r;)Lj$/time/temporal/v;
...
.method public final k(Lj$/time/temporal/n;)Lj$/time/temporal/v;
    ...
    .line 1146
    invoke-virtual {p0, v2, v1}, Lj$/time/temporal/w;->m(II)I
    ...
    invoke-interface {v1, p1}, Lj$/time/chrono/m;->w(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    invoke-interface {p1, v0, v1, v2}, Lj$/time/chrono/b;->b(JLj$/time/temporal/t;)Lj$/time/chrono/b;
...
.method public final l(Lj$/time/temporal/m;J)Lj$/time/temporal/m;
    ...
    .line 912
    invoke-interface {p1, p0}, Lj$/time/temporal/n;->g(Lj$/time/temporal/r;)I
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lj$/time/temporal/w;->f(Lj$/time/chrono/m;III)Lj$/time/chrono/b;
    ...
    invoke-interface {p1, p2, p3, v0}, Lj$/time/temporal/m;->b(JLj$/time/temporal/t;)Lj$/time/temporal/m;
