...
.method public final d(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0, v3}, Lj$/time/temporal/n;->c(Lj$/time/temporal/r;)Z
    ...
    .line 3417
    invoke-interface {v0, v3}, Lj$/time/temporal/n;->y(Lj$/time/temporal/r;)J
    ...
    .line 859
    iget-object v2, v2, Lj$/time/LocalDateTime;->b:Lj$/time/k;

    .line 729
    iget-byte v2, v2, Lj$/time/k;->c:B
    ...
    .line 859
    iget-object v13, v2, Lj$/time/LocalDateTime;->b:Lj$/time/k;

    .line 729
    iget-byte v13, v13, Lj$/time/k;->c:B
    ...
    .line 750
    iget-object v2, v2, Lj$/time/LocalDateTime;->a:Lj$/time/g;

    .line 762
    iget v2, v2, Lj$/time/g;->a:I
...
.method public final g(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    .line 3483
    invoke-virtual {v1, v2, v3}, Lj$/time/format/u;->l(Lj$/time/temporal/r;I)V
    ...
    .line 3484
    invoke-virtual {v1, v6, v3}, Lj$/time/format/u;->l(Lj$/time/temporal/r;I)V
    ...
    .line 3485
    invoke-virtual {v1, v5, v3}, Lj$/time/format/u;->l(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v1, v8, v10, v11}, Lj$/time/format/u;->q(Ljava/util/Locale;Lj$/time/format/e0;Lj$/time/chrono/m;)Lj$/time/format/DateTimeFormatter;
    ...
    .line 361
    invoke-static {v14, v12, v13}, Lj$/time/g;->U(III)Lj$/time/g;

    move-result-object v12

    .line 362
    invoke-static {v2, v6, v5, v3}, Lj$/time/k;->O(IIII)Lj$/time/k;
    ...
    invoke-direct {v3, v12, v2}, Lj$/time/LocalDateTime;-><init>(Lj$/time/g;Lj$/time/k;)V

    int-to-long v5, v9

    .line 1286
    invoke-virtual {v12, v5, v6}, Lj$/time/g;->Y(J)Lj$/time/g;

    move-result-object v5

    .line 1287
    invoke-virtual {v3, v5, v2}, Lj$/time/LocalDateTime;->T(Lj$/time/g;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v10, v11, v5, v6}, Lj$/com/android/tools/r8/a;->O(JJ)J
