...
.method public constructor <init>(Lj$/time/Instant;Lj$/time/format/DateTimeFormatter;)V
    ...
    .line 132
    :cond_0
    sget-object v1, Lj$/time/temporal/s;->b:Lj$/time/h;

    invoke-virtual {p1, v1}, Lj$/time/Instant;->d(Lj$/time/h;)Ljava/lang/Object;
    ...
    .line 133
    sget-object v2, Lj$/time/temporal/s;->a:Lj$/time/h;

    invoke-virtual {p1, v2}, Lj$/time/Instant;->d(Lj$/time/h;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v5}, Lj$/time/Instant;->c(Lj$/time/temporal/r;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/m;->w(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    invoke-virtual {p1, v7}, Lj$/time/Instant;->c(Lj$/time/temporal/r;)Z
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/x;-><init>(Lj$/time/chrono/b;Lj$/time/Instant;Lj$/time/chrono/m;Lj$/time/ZoneId;)V
...
.method public final a(Lj$/time/temporal/r;)Ljava/lang/Long;
    ...
    invoke-interface {v1, p1}, Lj$/time/temporal/n;->c(Lj$/time/temporal/r;)Z
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/n;->y(Lj$/time/temporal/r;)J
...
.method public final b(Lj$/time/h;)Ljava/lang/Object;
    .locals 4

    .line 287
    iget-object v0, p0, Lj$/time/format/y;->a:Lj$/time/temporal/n;

    invoke-interface {v0, p1}, Lj$/time/temporal/n;->d(Lj$/time/h;)Ljava/lang/Object;
