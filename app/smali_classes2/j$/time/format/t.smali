...
.method public constructor <init>(Lj$/time/format/g0;Z)V
    ...
    sget-object v1, Lj$/time/temporal/s;->e:Lj$/time/h;

    invoke-direct {p0, v1, v0}, Lj$/time/format/s;-><init>(Lj$/time/h;Ljava/lang/String;)V
...
.method public final d(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    .line 4106
    :cond_0
    invoke-virtual {v0}, Lj$/time/ZoneId;->f()Ljava/lang/String;
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/n;->c(Lj$/time/temporal/r;)Z
    ...
    invoke-static {v3}, Lj$/time/Instant;->L(Lj$/time/temporal/n;)Lj$/time/Instant;
    ...
    .line 4114
    invoke-interface {v3, v8}, Lj$/time/temporal/n;->c(Lj$/time/temporal/r;)Z
    ...
    .line 4115
    invoke-interface {v3, v5}, Lj$/time/temporal/n;->y(Lj$/time/temporal/r;)J

    move-result-wide v9

    invoke-static {v9, v10}, Lj$/time/g;->V(J)Lj$/time/g;

    move-result-object v5

    .line 4116
    invoke-interface {v3, v8}, Lj$/time/temporal/n;->y(Lj$/time/temporal/r;)J

    move-result-wide v8

    invoke-static {v8, v9}, Lj$/time/k;->P(J)Lj$/time/k;

    move-result-object v3

    .line 1831
    invoke-static {v5, v3}, Lj$/time/LocalDateTime;->N(Lj$/time/g;Lj$/time/k;)Lj$/time/LocalDateTime;
    ...
    .line 293
    invoke-static {v3, v0, v6}, Lj$/time/z;->K(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/z;

    move-result-object v0

    .line 0
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->r(Lj$/time/chrono/j;)J
