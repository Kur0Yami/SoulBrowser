...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/DoubleStream;->average()Lj$/util/c0;
...
.method public final synthetic findAny()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/DoubleStream;->findAny()Lj$/util/c0;
...
.method public final synthetic findFirst()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/DoubleStream;->findFirst()Lj$/util/c0;
...
.method public final flatMap(Ljava/util/function/DoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/DoubleStream;->d(Lj$/util/p;)Lj$/util/stream/DoubleStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfDouble;
    ...
    invoke-direct {v1, v0}, Lj$/util/h0;-><init>(Lj$/util/PrimitiveIterator$OfDouble;)V
...
.method public final synthetic max()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/DoubleStream;->max()Lj$/util/c0;
...
.method public final synthetic min()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/DoubleStream;->min()Lj$/util/c0;
...
.method public final synthetic reduce(Ljava/util/function/DoubleBinaryOperator;)Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/DoubleStream;->reduce(Ljava/util/function/DoubleBinaryOperator;)Lj$/util/c0;

    move-result-object p1

    invoke-static {p1}, Lj$/com/android/tools/r8/a;->C(Lj$/util/c0;)Ljava/util/OptionalDouble;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfDouble;
    ...
    invoke-static {v0}, Lj$/util/r0;->a(Lj$/util/Spliterator$OfDouble;)Ljava/util/Spliterator$OfDouble;
