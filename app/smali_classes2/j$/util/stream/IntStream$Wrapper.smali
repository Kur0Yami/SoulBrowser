...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->D(Lj$/util/d0;)Ljava/util/OptionalInt;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Lj$/util/j0;

    if-eqz v1, :cond_1

    check-cast v0, Lj$/util/j0;

    iget-object v0, v0, Lj$/util/j0;->a:Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-direct {v1, v0}, Lj$/util/k0;-><init>(Lj$/util/PrimitiveIterator$OfInt;)V
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->D(Lj$/util/d0;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/t0;->a(Lj$/util/Spliterator$OfInt;)Ljava/util/Spliterator$OfInt;
