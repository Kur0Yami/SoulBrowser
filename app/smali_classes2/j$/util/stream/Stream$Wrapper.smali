...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/util/stream/z6;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/util/stream/z6;

    iget-object p0, p0, Lj$/util/stream/z6;->a:Ljava/util/stream/Stream;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->B(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->y(Lj$/util/p;)Lj$/util/stream/DoubleStream;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->n(Lj$/util/p;)Lj$/util/stream/IntStream;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->l(Lj$/util/p;)Lj$/util/stream/LongStream;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->B(Lj$/util/Optional;)Ljava/util/Optional;
