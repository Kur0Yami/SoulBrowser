...
.method static constructor <clinit>()V
    ...
    .line 67
    sput-object v0, Lj$/util/stream/v3;->a:Lj$/util/stream/u2;
    ...
    .line 68
    sput-object v0, Lj$/util/stream/v3;->b:Lj$/util/stream/s2;
    ...
    .line 69
    sput-object v0, Lj$/util/stream/v3;->c:Lj$/util/stream/t2;
    ...
    .line 70
    sput-object v0, Lj$/util/stream/v3;->d:Lj$/util/stream/r2;
...
.method public static D(Lj$/util/stream/k5;Ljava/lang/Double;)V
    .locals 2
    ...
    invoke-interface {p0, v0, v1}, Lj$/util/stream/k5;->accept(D)V
    ...
    invoke-static {p0, p1}, Lj$/util/stream/p8;->a(Ljava/lang/Class;Ljava/lang/String;)V
...
.method public static bridge synthetic E(Lj$/util/stream/k5;Ljava/lang/Object;)V
    .locals 0

    .line 223
    check-cast p1, Ljava/lang/Double;

    invoke-interface {p0, p1}, Lj$/util/stream/k5;->n(Ljava/lang/Double;)V

    return-void
.end method

.method public static F(Lj$/util/stream/l5;Ljava/lang/Integer;)V
    .locals 1
    ...
    invoke-interface {p0, p1}, Lj$/util/stream/l5;->accept(I)V
...
.method public static bridge synthetic G(Lj$/util/stream/l5;Ljava/lang/Object;)V
    .locals 0

    .line 189
    check-cast p1, Ljava/lang/Integer;

    invoke-interface {p0, p1}, Lj$/util/stream/l5;->d(Ljava/lang/Integer;)V

    return-void
.end method

.method public static H(Lj$/util/stream/m5;Ljava/lang/Long;)V
    .locals 2
    ...
    invoke-interface {p0, v0, v1}, Lj$/util/stream/m5;->accept(J)V
...
.method public static bridge synthetic I(Lj$/util/stream/m5;Ljava/lang/Object;)V
    .locals 0

    .line 206
    check-cast p1, Ljava/lang/Long;

    invoke-interface {p0, p1}, Lj$/util/stream/m5;->l(Ljava/lang/Long;)V
...
.method public static P(Lj$/util/stream/w1;Ljava/util/function/Consumer;)V
    ...
    .line 489
    invoke-interface {p0}, Lj$/util/stream/b2;->spliterator()Lj$/util/Spliterator$OfPrimitive;
...
.method public static S(Lj$/util/stream/w1;JJ)Lj$/util/stream/w1;
    ...
    .line 520
    invoke-static {v0, v1}, Lj$/util/stream/v3;->e0(J)Lj$/util/stream/r1;

    move-result-object v3

    .line 521
    invoke-interface {v3, v0, v1}, Lj$/util/stream/n5;->c(J)V
    ...
    :cond_3
    :goto_2
    invoke-interface {v3}, Lj$/util/stream/n5;->end()V
...
.method public static T(Lj$/util/stream/y1;JJ)Lj$/util/stream/y1;
    ...
    .line 364
    invoke-static {v0, v1}, Lj$/util/stream/v3;->n0(J)Lj$/util/stream/s1;
...
.method public static U(Lj$/util/stream/a2;JJ)Lj$/util/stream/a2;
    ...
    .line 441
    invoke-static {v0, v1}, Lj$/util/stream/v3;->o0(J)Lj$/util/stream/t1;
...
.method public static V(Lj$/util/stream/c2;JJLjava/util/function/IntFunction;)Lj$/util/stream/c2;
    ...
    .line 125
    invoke-static {v1, v2, p5}, Lj$/util/stream/v3;->W(JLjava/util/function/IntFunction;)Lj$/util/stream/u1;

    move-result-object p5

    .line 126
    invoke-interface {p5, v1, v2}, Lj$/util/stream/n5;->c(J)V
    ...
    :cond_3
    :goto_2
    invoke-interface {p5}, Lj$/util/stream/n5;->end()V
...
.method public static X(Lj$/util/stream/v3;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/c2;
    .locals 6

    .line 328
    invoke-virtual {p0, p1}, Lj$/util/stream/v3;->h0(Lj$/util/Spliterator;)J
    ...
    invoke-direct {p3, p1, p0, p2}, Lj$/util/stream/m3;-><init>(Lj$/util/Spliterator;Lj$/util/stream/v3;[Ljava/lang/Object;)V
    ...
    .line 2207
    invoke-direct/range {v0 .. v5}, Lj$/util/stream/h2;-><init>(Lj$/util/stream/v3;Lj$/util/Spliterator;Ljava/util/function/LongFunction;Ljava/util/function/BinaryOperator;I)V
    ...
    .line 337
    invoke-static {p0, p3}, Lj$/util/stream/v3;->i0(Lj$/util/stream/c2;Ljava/util/function/IntFunction;)Lj$/util/stream/c2;
...
.method public static Y(Lj$/util/stream/v3;Lj$/util/Spliterator;Z)Lj$/util/stream/w1;
    .locals 6
    ...
    invoke-direct {v0, p1, p0, p2}, Lj$/util/stream/j3;-><init>(Lj$/util/Spliterator;Lj$/util/stream/v3;[D)V
    ...
    .line 451
    invoke-static {p0}, Lj$/util/stream/v3;->j0(Lj$/util/stream/w1;)Lj$/util/stream/w1;
...
.method public static Z(Lj$/util/stream/v3;Lj$/util/Spliterator;Z)Lj$/util/stream/y1;
    .locals 6
    ...
    invoke-direct {v0, p1, p0, p2}, Lj$/util/stream/k3;-><init>(Lj$/util/Spliterator;Lj$/util/stream/v3;[I)V
    ...
    .line 375
    invoke-static {p0}, Lj$/util/stream/v3;->k0(Lj$/util/stream/y1;)Lj$/util/stream/y1;
...
.method public static a0(Lj$/util/stream/v3;Lj$/util/Spliterator;Z)Lj$/util/stream/a2;
    .locals 6
    ...
    invoke-direct {v0, p1, p0, p2}, Lj$/util/stream/l3;-><init>(Lj$/util/Spliterator;Lj$/util/stream/v3;[J)V
    ...
    .line 413
    invoke-static {p0}, Lj$/util/stream/v3;->l0(Lj$/util/stream/a2;)Lj$/util/stream/a2;
...
.method public static b0(Lj$/util/stream/d7;Lj$/util/stream/c2;Lj$/util/stream/c2;)Lj$/util/stream/e2;
    .locals 2
...
.method public static e0(J)Lj$/util/stream/r1;
    ...
    .line 980
    invoke-direct {p0}, Lj$/util/stream/x6;-><init>()V

    return-object p0
.end method

.method public static f0(Lj$/util/stream/d7;)Lj$/util/stream/v2;
    .locals 3
    ...
    .line 95
    sget-object p0, Lj$/util/stream/v3;->d:Lj$/util/stream/r2;
    ...
    .line 94
    :cond_1
    sget-object p0, Lj$/util/stream/v3;->c:Lj$/util/stream/t2;

    return-object p0

    .line 93
    :cond_2
    sget-object p0, Lj$/util/stream/v3;->b:Lj$/util/stream/s2;

    return-object p0

    .line 92
    :cond_3
    sget-object p0, Lj$/util/stream/v3;->a:Lj$/util/stream/u2;
...
.method public static i0(Lj$/util/stream/c2;Ljava/util/function/IntFunction;)Lj$/util/stream/c2;
    ...
    invoke-direct {v0, p0, p1}, Lj$/util/stream/t3;-><init>(Lj$/util/stream/c2;[Ljava/lang/Object;)V
...
.method public static j0(Lj$/util/stream/w1;)Lj$/util/stream/w1;
    ...
    .line 2152
    invoke-direct {v1, p0, v0}, Lj$/util/stream/s3;-><init>(Lj$/util/stream/b2;Ljava/lang/Object;)V
...
.method public static m0(Ljava/util/function/Function;)Lj$/util/p;
    .locals 2
...
.method public static p0(Lj$/util/stream/p1;)Lj$/util/concurrent/t;
    ...
    invoke-direct {v0, v1, p0, v2}, Lj$/util/concurrent/t;-><init>(Lj$/util/stream/d7;Lj$/util/stream/p1;Ljava/util/function/Supplier;)V
...
# virtual methods
.method public abstract c0(Lj$/util/Spliterator;Lj$/util/stream/n5;)V
.end method

.method public abstract d0(Lj$/util/Spliterator;Lj$/util/stream/n5;)Z
.end method
...
.method public f(Lj$/util/stream/a;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    .line 913
    invoke-virtual {p0}, Lj$/util/stream/v3;->u0()Lj$/util/stream/q4;

    move-result-object v0

    invoke-virtual {p1, p2, v0}, Lj$/util/stream/a;->v0(Lj$/util/Spliterator;Lj$/util/stream/n5;)Lj$/util/stream/n5;
...
.method public i(Lj$/util/stream/v3;Lj$/util/Spliterator;)Ljava/lang/Object;
    .locals 1

    .line 919
    new-instance v0, Lj$/util/stream/x4;

    invoke-direct {v0, p0, p1, p2}, Lj$/util/stream/x4;-><init>(Lj$/util/stream/v3;Lj$/util/stream/v3;Lj$/util/Spliterator;)V
...
.method public abstract u0()Lj$/util/stream/q4;
.end method
...
.method public abstract v0(Lj$/util/Spliterator;Lj$/util/stream/n5;)Lj$/util/stream/n5;
.end method

.method public abstract w0(Lj$/util/stream/n5;)Lj$/util/stream/n5;
.end method
